...
| **BBiG im Volltext** | Alle 121 Paragrafen des Berufsbildungsgesetzes als eigene Seiten (`#/gesetz/bbig`): durchsuchbar, mit Gliederung, Nachbar-Navigation und Rückverweisen auf die Artikel; jedes §-Zitat im Werkzeug springt direkt auf die Norm. Nach Gesetzesänderung: `python3 tools/gesetz_import.py` |
