...
| **Download-Center** | 86 Quellen im Baum: RP-Formulare (BAV!), Ausbildungspläne, 36 lokale PDFs, alle 14 Ausbildungsordnungen der grünen Berufe, Gesetze, BA-Förderung, SVLFG, öffentliche Portale |
| **KI-Assistent (lokal)** | Antworten ausschließlich aus der Wissensbasis mit Quellenangaben (§§ + Artikel) — keine Eingabe verlässt das Gerät, keine Rechtsberatung |
