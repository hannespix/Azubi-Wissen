...
window.WISSEN = {
  ...
  /* =================== Vertrag & Ausbildungsstart =================== */
  {
    ...
    fakten: [
      ...
      "Bei **[[jugendliche|Minderjährigen]]** müssen die gesetzlichen Vertreter (i. d. R. beide Elternteile) den Vertrag mit abschließen.",
    ...
    abschnitte: [
      ...
      { t: "Änderungen im laufenden Ausbildungsverhältnis", d: 3, text: "Wesentliche Änderungen — etwa [[teilzeit-verkuerzung|Verkürzung, Verlängerung oder Wechsel in Teilzeit]], eine neue Fachrichtung oder ein [[ausbilder|Ausbilderwechsel]] — werden als **Änderungsvertrag** schriftlich festgehalten und der zuständigen Stelle unverzüglich zur [[eintragung|Nachtragung im Verzeichnis]] gemeldet (§ 36 Abs. 1 BBiG). So bleiben Verzeichnis, Vergütungsstaffel und Prüfungstermin stimmig. Mündliche Nebenabreden vermeiden: Was nicht niedergelegt ist, führt später zu Beweisproblemen." }
    ],
    rollen: {
    ...
    faq: [
      ...
      { f: "Was gilt, wenn der Betrieb den Vertrag nicht einreicht?", a: "Der Vertrag bleibt wirksam — aber ohne [[eintragung|Eintragung]] fehlt am Ende die Zulassungsgrundlage für die Abschlussprüfung, und der Betrieb verletzt seine Pflicht aus § 36 BBiG. Azubis sollten nachfragen und sich notfalls an die [[ausbildungsberatung|Ausbildungsberatung]] wenden — sie fordert die Unterlagen beim Betrieb an." }
    ],
...

  {
    ...
    fakten: [
      ...
      "Bei Minderjährigen muss die Bescheinigung über die **[[jugendliche|ärztliche Erstuntersuchung]]** vorliegen — fehlt sie, kann nicht eingetragen werden. Findet der Betrieb keine untersuchende Praxis, hilft der Abschnitt „Wenn keine Praxis untersuchen will“ weiter.",
    ...
    abschnitte: [
      { t: "Benötigte Unterlagen", d: 2, text: "Zur Eintragung gehören üblicherweise:\n\n- der unterschriebene **[[ausbildungsvertrag|Berufsausbildungsvertrag]]** (alle Ausfertigungen)\n- der **betriebliche Ausbildungsplan** (sachliche und zeitliche Gliederung)\n- bei Minderjährigen die **[[jugendliche|ärztliche Erstuntersuchung]]** (§ 32 JArbSchG)\n- Angaben zur **[[ausbilder|Ausbildereignung]]**, falls noch nicht bekannt\n- ggf. Nachweise zu **[[teilzeit-verkuerzung|Verkürzung]]** oder Teilzeitausbildung" },
      { t: "Im Gartenbau: Ausfertigungen und Anlagen", d: 3, text: "Das Hinweisblatt der zuständigen Stelle legt die Stückzahlen fest — sie unterscheiden sich nach Fachrichtung:\n\n- **Berufsausbildungsvertrag: 3-fach**\n- **Anlage überbetriebliche Ausbildung: 4-fach** — im Garten- und Landschaftsbau die AuGaLa-Anlage, in allen übrigen Fachrichtungen die DEULA-Anlage\n- **betrieblicher Ausbildungsplan** (ausgefüllt): 1-fach\n- **Zeugnis des letzten allgemeinbildenden Schulabschlusses** als Kopie\n- bei Verbund- oder kooperativer Ausbildung: **Kooperationsvertrag**\n- bei unter 18-Jährigen: **ärztliche Bescheinigung über die Erstuntersuchung** (§ 32 Abs. 1 JArbSchG)\n- bei Verkürzung: **Zeugnis der Hochschulreife** bzw. Abschlusszeugnis der vorherigen Berufsausbildung (Kopie)\n\nDrei Stolpersteine aus der Praxis: Im ausfüllbaren Vertragsformular ist **zuerst der Beruf im Dropdown** zu wählen (bei dualem Studium zusätzlich das Feld „gekoppelt mit“). Die **achtstellige Betriebsnummer der Ausbildungsstätte** (§ 18i Abs. 1 / § 18k Abs. 1 SGB IV) gehört zwingend in den Vertrag (§ 34 Abs. 2 Nr. 10 BBiG). Und der **Urlaubsanspruch ist für jedes Kalenderjahr getrennt** einzutragen — bei Minderjährigen unterschreiben außerdem **beide Elternteile bzw. alle gesetzlichen Vertreter**." },
    ...
    faq: [
      ...
      { f: "Was passiert, wenn der Vertrag Mängel hat?", a: "Die zuständige Stelle beanstandet den Mangel (z. B. Vergütung unter Mindestniveau, fehlende Überstundenregelung, unzulässige Kostenklausel) und fordert die Korrektur an — die Eintragung wird bis zur Nachbesserung zurückgestellt. Typische Stolperstellen zeigt der Artikel zum [[ausbildungsvertrag|Berufsausbildungsvertrag]]." }
    ],
...

  {
    ...
    faq: [
      ...
      { f: "Kann mir in der Probezeit einfach so gekündigt werden?", a: "Ja — in der Probezeit können beide Seiten jederzeit ohne Frist und ohne Begründung kündigen. Die Kündigung muss aber schriftlich erfolgen, und besonderer Kündigungsschutz (z. B. bei Schwangerschaft oder Schwerbehinderung) bleibt bestehen. Nach der Probezeit gelten die deutlich strengeren Regeln der [[kuendigung|Kündigung]]." },
      { f: "Zählt die Probezeit zur Ausbildungszeit?", a: "Ja — die Probezeit ist der erste Abschnitt des Ausbildungsverhältnisses, wird voll vergütet und zählt komplett zur Ausbildungsdauer. Auch das [[berichtsheft|Berichtsheft]] wird ab dem ersten Tag geführt." }
    ],
...

  {
    ...
    recht: [
      ...
      { n: "§ 44 JArbSchG", t: "Kosten der Untersuchungen" },
    ...
    fakten: [
      ...
      "**Nachuntersuchung:** vor Ablauf des ersten Beschäftigungsjahres; liegt die Bescheinigung 14 Monate nach Beginn nicht vor, gilt ein **Beschäftigungsverbot**. Der zuständigen Stelle ist sie **bis zur Anmeldung zur Zwischenprüfung** zur Einsicht vorzulegen (§ 35 Abs. 2 BBiG).",
      "Die Untersuchungen sind für Jugendliche **kostenfrei** — das Land trägt die Kosten (§ 44 JArbSchG). Nötig ist dafür der **Untersuchungsberechtigungsschein** der zuständigen Behörde (in der Regel die Gemeinde).",
      "**Praxislage:** Immer mehr Arztpraxen lehnen die Untersuchung ab. Die erstattungsfähige Gebühr liegt seit 1976 bei **23,32 €**, marktüblich sind über 80 €. Eine Pflicht zur Durchführung besteht für Ärztinnen und Ärzte nicht.",
    ...
    abschnitte: [
      ...
      { t: "Wenn keine Praxis untersuchen will", d: 2, text: "Seit einiger Zeit lehnen viele Praxen die Jugendarbeitsschutzuntersuchung ab. Grund ist die Gebühr: Erstattungsfähig sind **23,32 €** — ein Satz von 1976, während marktüblich über 80 € aufgerufen werden. Ohne Untersuchung darf der oder die Jugendliche nicht beschäftigt werden, und wir können den Vertrag nicht eintragen. Das trifft im Sommer ganze Jahrgänge.\n\nWas in dieser Lage hilft:\n\n- **Alle Fachrichtungen dürfen untersuchen.** Es gibt keine rechtliche Begrenzung auf Kinder- und Jugendmedizin — auch Hausarztpraxen, Betriebsärztinnen und -ärzte sowie der Öffentliche Gesundheitsdienst kommen in Frage. Die Arztwahl ist frei, also lohnt die Suche über die Kinderarztpraxis hinaus.\n- **Ablehnen ist erlaubt.** Eine Pflicht zur Durchführung lässt sich aus keiner Vorschrift ableiten; eine Praxis kann jederzeit absagen. Streit darüber führt nicht weiter.\n- **Privat abrechnen ist zulässig.** Praxen dürfen die Untersuchung als Selbstzahlerleistung anbieten (üblich rund 81,62 €, 3,5-facher Steigerungssatz der GOÄ). Sie müssen vorher **wirtschaftlich aufklären** — der Preis muss also vor dem Termin auf dem Tisch liegen.\n- **Der Betrieb darf die Rechnung übernehmen.** Nach Auskunft der Bundesärztekammer ist das möglich. Für viele Betriebe der schnellste Weg, den Ausbildungsstart zu retten.\n\nDer **Landesausschuss für Berufsbildung** empfiehlt der Landesregierung, die Gebührenerstattung auf 96,60 € anzuheben; der Entwurf der neuen Gebührenordnung für Ärzte sieht 96,90 € vor, tritt aber frühestens 2027 in Kraft. Bis dahin soll eine Übergangslösung zwischen Kassenärztlichen Vereinigungen und Kostenträgern gefunden werden. Die vollständige Empfehlung mit Handreichung liegt im Download-Center." },
      ...
      { t: "Weitere Schutzregeln für unter 18-Jährige", d: 3, text: "Neben den Untersuchungen enthält das JArbSchG eigene Schutzstandards:\n\n- **[[arbeitszeit-jugendliche|Arbeitszeit, Pausen und Nachtruhe]]** sind enger begrenzt als bei Erwachsenen\n- **gefährliche Arbeiten** (§ 22 JArbSchG) sind verboten, soweit sie nicht unter Aufsicht zum Ausbildungsziel gehören — im grünen Bereich relevant etwa bei Pflanzenschutzmitteln, Motorsäge und bestimmten Maschinen\n- **Akkord- und tempoabhängige Arbeiten** sind untersagt (§ 23 JArbSchG)\n- vor Beginn und bei wesentlichen Änderungen ist über **Unfall- und Gesundheitsgefahren zu unterweisen** (§ 29 JArbSchG)\n\nDer Betrieb muss das JArbSchG und die Aufsichtsbehörde im Betrieb **aushängen**, wenn Jugendliche beschäftigt werden (§ 47 JArbSchG)." }
    ],
    rollen: {
      azubi: "Die Untersuchung kostet dich nichts — den Berechtigungsschein bekommst du bei deiner Gemeinde. Findet deine Kinderarztpraxis keinen Termin oder lehnt sie ab: Jede Arztpraxis darf untersuchen, auch die Hausarztpraxis. Ohne Nachuntersuchung darfst du nach 14 Monaten nicht mehr beschäftigt werden, also kümmere dich rechtzeitig um den Termin.",
      betrieb: "Ohne Erstuntersuchung dürfen Sie Jugendliche gar nicht erst beschäftigen; ohne Nachuntersuchung endet die Beschäftigungserlaubnis 14 Monate nach Beginn. Erinnerungsfristen ins Fristenbuch aufnehmen. Wenn keine Praxis untersuchen will: über die Kinderarztpraxis hinaus suchen (jede Fachrichtung darf), notfalls die private Rechnung übernehmen — das ist zulässig und rettet oft den Ausbildungsstart.",
      beratung: "Bei Betriebsbesuchen Bescheinigungen zeigen lassen. Fehlende Nachuntersuchung ist ein klassischer, schnell behebbarer Mangel — schriftlich mit Frist anfordern und Wiedervorlage setzen. Bei Meldungen „kein Arzt untersucht“ die vier Wege aus der LAB-Handreichung durchgehen, statt die Eintragung schlicht zu vertagen."
    },
    faq: [
      ...
      { f: "Keine Arztpraxis will die Untersuchung machen — was jetzt?", a: "Erstens: Die Suche nicht auf Kinder- und Jugendmedizin beschränken. Untersuchen darf jede Ärztin und jeder Arzt, unabhängig von der Fachrichtung — auch Hausarztpraxen, Betriebsärztinnen und -ärzte und der Öffentliche Gesundheitsdienst; die Arztwahl ist frei. Zweitens: Absagen sind rechtlich zulässig, eine Pflicht zur Durchführung gibt es nicht. Drittens: Die Praxis darf die Untersuchung als Selbstzahlerleistung anbieten (üblich rund 81,62 €) und muss dabei vorher über die Kosten aufklären. Hintergrund ist die erstattungsfähige Gebühr von 23,32 €, die seit 1976 nicht angepasst wurde." },
      { f: "Darf der Betrieb die Arztrechnung übernehmen?", a: "Ja. Rechnet die Praxis privat ab, kann der Ausbildungsbetrieb die Rechnung übernehmen — die Bundesärztekammer hat das ausdrücklich bestätigt. Für viele Betriebe ist das der schnellste Weg, wenn der Ausbildungsbeginn sonst am fehlenden Nachweis scheitert. Der reguläre Weg bleibt der Untersuchungsberechtigungsschein der Gemeinde: Damit trägt das Land die Kosten (§ 44 JArbSchG)." },
      ...
      { f: "Gelten die Schutzregeln auch nach dem 18. Geburtstag?", a: "Nein — mit Volljährigkeit endet der Anwendungsbereich des JArbSchG. Ab dann gelten die allgemeinen Regeln des Arbeitszeitgesetzes ([[arbeitszeit-erwachsene|Arbeitszeit für Erwachsene]]); nur die Anrechnungs- und Freistellungsregeln für Berufsschule und Prüfungen gelten über § 15 BBiG für alle Azubis weiter." }
    ],
...

  {
    ...
    thema: "vertrag",
    titel: "Einstiegsqualifizierung (EQ) — der Weg vor der Ausbildung",
    kurz: "Die betriebliche Einstiegsqualifizierung nach § 54a SGB III bereitet vier bis zwölf Monate lang auf eine Ausbildung vor. Sie ist keine Berufsausbildung — deshalb muss der Betrieb dafür weder anerkannt sein noch einen Meister beschäftigen.",
    stichworte: ["EQ", "Einstiegsqualifizierung", "54a", "Praktikum", "Langzeitpraktikum", "EQ Plus", "Vorbereitung", "Qualifizierungsbausteine", "Praktikantenvertrag", "Agentur für Arbeit", "vor der Ausbildung"],
    recht: [
      { n: "§ 54a SGB III", t: "Einstiegsqualifizierung" },
      { n: "§ 26 BBiG", t: "Andere Vertragsverhältnisse" },
      { n: "§ 68 BBiG", t: "Berufsausbildungsvorbereitung" },
      { n: "§ 22 MiLoG", t: "Ausnahme vom Mindestlohn" },
      { n: "§ 8 BBiG", t: "Verkürzung nach der EQ" }
    ],
    fakten: [
      "**Vier bis höchstens zwölf Monate**, in Vollzeit oder in Teilzeit ab **20 Wochenstunden** (§ 54a Abs. 2 SGB III).",
      "Grundlage ist ein Vertrag nach **§ 26 BBiG** — also **keine Berufsausbildung**, sondern ein anderes Vertragsverhältnis.",
      "**Der Betrieb muss kein anerkannter Ausbildungsbetrieb sein und keinen Meister beschäftigen**: Die Eignung nach §§ 27–33 BBiG ist ausdrücklich **keine Fördervoraussetzung**. Die Agentur für Arbeit will damit auch nicht oder nicht mehr ausbildende Betriebe gewinnen.",
      "Fachlich muss der Betrieb trotzdem liefern können — die vereinbarten **Qualifizierungsbausteine** müssen echt vermittelt werden.",
      "Der Vertragsabschluss wird der **zuständigen Stelle angezeigt**; in Baden-Württemberg trägt das [[zustaendige-stelle|Regierungspräsidium]] ihn in das **Verzeichnis der Praktikantenverhältnisse** ein.",
      "Über die **Förderung entscheidet die Agentur für Arbeit** — Zuschuss zur Vergütung höchstens **276 € im Monat** plus pauschalierter Sozialversicherungsbeitrag.",
      "Zum Schluss: **betriebliches Zeugnis** vom Betrieb, auf Antrag zusätzlich das **Zertifikat der zuständigen Stelle**.",
      "Eine EQ verkürzt die spätere Ausbildung **nicht automatisch** — die Verkürzung wird nach [[teilzeit-verkuerzung|§ 8 BBiG]] gesondert beantragt."
    ],
    abschnitte: [
      { t: "Was die EQ ist — und was nicht", d: 2, text: "Die Einstiegsqualifizierung ist ein **betriebliches Langzeitpraktikum mit Förderung**, das gezielt auf einen anerkannten Ausbildungsberuf vorbereitet. Sie steht im **Vorfeld** der Ausbildung und gehört zur Berufsausbildungsvorbereitung.\n\nDaraus folgt die wichtigste Abgrenzung für die Beratung:\n\n- Der Vertrag ist **kein [[ausbildungsvertrag|Berufsausbildungsvertrag]]**, sondern ein Vertrag nach § 26 BBiG.\n- Es entsteht **kein Ausbildungsverhältnis** und kein Arbeitsverhältnis.\n- Die Zeit wird **nicht automatisch** auf eine spätere Ausbildung angerechnet.\n\nÜber § 26 BBiG gelten aber viele Ausbildungsregeln entsprechend — unter anderem die Pflicht zu einer angemessenen Vergütung (§ 17 Abs. 1 BBiG), die Regeln zu Probezeit und Kündigung sowie das [[zeugnis|Zeugnis]]." },
      { t: "Der Betrieb muss nicht anerkannt sein", d: 2, text: "Das ist die Frage, die in der Beratung am häufigsten falsch beantwortet wird. Die Fachlichen Weisungen der Bundesagentur für Arbeit sagen es wörtlich:\n\n> Um mit der EQ-Förderung auch nicht oder nicht mehr ausbildende Betriebe für die Ausbildung zu gewinnen, ist das Vorliegen der Eignung der Ausbildungsstätte und des Ausbildungspersonals im Sinne der §§ 27–33 BBiG nicht Voraussetzung für eine Förderung.\n\nEin Gartenbaubetrieb kann also eine EQ durchführen, obwohl er **noch nie ausgebildet hat**, **nicht als Ausbildungsstätte anerkannt ist** oder **derzeit keinen Ausbilder nach §§ 28–30 BBiG** beschäftigt. Die fehlende Anerkennung allein ist kein Ablehnungsgrund.\n\nDer rechtliche Grund steht in **§ 68 Abs. 2 BBiG**: Die §§ 27 bis 33 BBiG gelten nur für Berufsausbildungsvorbereitung, die **nicht** im Rahmen des SGB III oder einer vergleichbaren öffentlich geförderten Maßnahme durchgeführt wird. Bei einer geförderten EQ greifen sie deshalb nicht. Bei einem rein privaten Praktikum ohne Förderung können sie sehr wohl entsprechend gelten — deshalb lohnt zu Beginn die Frage: **echte EQ nach § 54a SGB III oder einfach ein Praktikum?**" },
      { t: "Was der Betrieb trotzdem können muss", d: 2, text: "„Nicht anerkannt“ heißt nicht „egal“. Inhalt und Vermittlung müssen geeignet sein, auf den Ausbildungsberuf vorzubereiten, und die geplanten **Qualifizierungsbausteine** gehören in den Vertrag. Der baden-württembergische Vordruck verlangt außerdem eine **verantwortliche Praktikumsleitung** namentlich.\n\nFür die fachliche Einschätzung durch die Ausbildungsberatung sind vier Fragen praktisch:\n\n- Wer leitet die Person im Alltag an, und welche gärtnerische Qualifikation oder Berufserfahrung bringt diese Person mit?\n- Welche Tätigkeiten stehen im Betrieb tatsächlich an?\n- Kann der Betrieb die angekreuzten Bausteine über die vereinbarte Dauer wirklich abdecken?\n- Läuft die EQ auf einen [[ausbildungsvertrag|Ausbildungsvertrag]] zu, oder ersetzt sie einen?\n\nDas ist eine **Qualitätsprüfung der Maßnahme**, keine Anerkennungsprüfung nach §§ 27–30 BBiG. Die Bewertungsmaßstäbe sind unterschiedlich, und dieser Unterschied sollte im Vermerk auch benannt werden." },
      { t: "Wenn die Agentur für Arbeit nachfragt", d: 2, text: "Der Arbeitgeber bestätigt im Förderantrag, dass er den EQ-Vertrag der zuständigen Stelle angezeigt hat. Bestehen Zweifel daran **oder an den Voraussetzungen des Betriebs, eine EQ im Sinne des Gesetzes durchführen zu können**, soll die Agentur für Arbeit eine **Bestätigung bzw. Einschätzung der zuständigen Stelle** einholen.\n\nGenau an dieser Stelle kommt die Ausbildungsberatung ins Spiel. Die Frage lautet dann **nicht** „Erfüllt der Betrieb alle Voraussetzungen für eine Anerkennung als Ausbildungsbetrieb?“, sondern: **„Ist dieser Betrieb fachlich und organisatorisch in der Lage, die vereinbarte Einstiegsqualifizierung sinnvoll durchzuführen?“**" },
      { t: "Vertrag, Anzeige und Unterlagen in Baden-Württemberg", d: 2, text: "Für Gärtner/in stellen die Regierungspräsidien einen eigenen **Einstiegsqualifizierungsvertrag nach § 54a SGB III** bereit — **3-fach** auszufertigen. Er enthält Beginn und Ende, Probezeit (in Wochen), Vergütung und abgeführten Sozialversicherungsbeitrag, tägliche und wöchentliche Qualifizierungszeit, Urlaub nach BUrlG bzw. JArbSchG, den vorgesehenen Berufsschulbesuch, die zuständige Agentur für Arbeit und die verantwortliche Praktikumsleitung. Oben trägt das Regierungspräsidium die **Nummer im Verzeichnis der Praktikantenverhältnisse** ein.\n\nDazu gehören je Fachrichtung die **Qualifizierungsbausteine** als Anlage — im Garten- und Landschaftsbau sind aus zwanzig Bausteinen (Rasenpflege, Pflege von Beeten und Pflanzungen, Pflasterarbeiten, wassergebundene Decken, Entwässerung, Teichbau, Trockenmauerbau, Gehölzschnitt, Bodenkunde, Staudenverwendung u. a.) **mindestens drei** anzukreuzen; für Obstbau und Zierpflanzenbau gibt es eigene Formulare.\n\n**Die Registrierung des EQ-Vertrags ist keine Anerkennung des Betriebs als Ausbildungsstätte.** Das gehört in jedes Beratungsgespräch, damit später niemand überrascht ist." },
      { t: "Wer gefördert werden kann", d: 3, text: "§ 54a Abs. 4 SGB III nennt drei Gruppen:\n\n- bei der Agentur gemeldete **Ausbildungsbewerberinnen und -bewerber mit eingeschränkten Vermittlungsperspektiven**, die auch nach den Nachvermittlungsaktionen keine Stelle haben\n- **Ausbildungsuchende, die noch nicht in vollem Maße über die Ausbildungsreife verfügen**\n- **lernbeeinträchtigte und sozial benachteiligte** Ausbildungsuchende\n\nFür **Menschen mit Behinderungen** kann eine EQ auch gefördert werden, wenn sie auf eine Ausbildung nach [[fw-grundlagen|§ 66 BBiG]] vorbereitet — für die Fachwerkerausbildung im Gartenbau ist die EQ deshalb ein regulärer Zugangsweg.\n\nDie Zugehörigkeit zum förderfähigen Personenkreis stellt **die Agentur für Arbeit** fest, nicht das Regierungspräsidium — auch dann, wenn der Betrieb die Person selbst gefunden hat.\n\nDie Anordnung des BA-Verwaltungsrats (EQFAO) setzt zwei Vorrangregeln: Die Vermittlung in eine **betriebliche Ausbildung geht der EQ vor**, und die Förderung soll **vorrangig Ausbildungsuchenden ohne (Fach-)Abitur** zugutekommen — bei (Fach-)Abitur ist sie nur im begründeten Einzelfall möglich (befristet bis 31.12.2029)." },
      { t: "Ausschlüsse", d: 3, text: "Nach § 54a Abs. 5 SGB III ist eine Förderung ausgeschlossen, wenn die Person\n\n- bereits eine EQ **im selben Betrieb oder Unternehmen** durchlaufen hat oder\n- in den **letzten drei Jahren** vor Beginn im Unternehmen oder einem verbundenen Unternehmen **versicherungspflichtig beschäftigt** war.\n\nDasselbe gilt, wenn die EQ **im Betrieb der Eltern, Ehegatten oder Lebenspartner** stattfindet. Für vorzeitig gelöste Ausbildungsverhältnisse sieht das Gesetz eine Ausnahme vor." },
      { t: "Dauer, Beginn und Zeit im Betrieb", d: 3, text: "Gefördert werden **vier bis zwölf Monate**. Nach der EQFAO müssen grundsätzlich **mindestens 70 Prozent der Gesamtzeit im Betrieb** stattfinden; nimmt die Person an einem erforderlichen Berufssprachkurs teil, kann dieser Anteil sinken.\n\nBeim Beginn wirkt der Vorrang der Ausbildungsvermittlung nach: Für Bewerberinnen und Bewerber nach § 54a Abs. 4 Nr. 1 SGB III soll die Förderung in der Regel **nicht vor dem 1. Oktober** beginnen, für die übrigen Gruppen **nicht vor dem 1. August**. Die EQ soll im Regelfall **im Monat vor dem nächsten Ausbildungsjahr enden** — damit der Übergang in die Ausbildung passt." },
      { t: "Berufsschule", d: 3, text: "Die EQ ist kein Ausbildungsvertrag, aber die Schule bleibt wichtig. Auf die Einhaltung einer bestehenden **Berufsschulpflicht** ist hinzuwirken; darüber hinaus wird ausdrücklich empfohlen, die Teilnehmenden in der **entsprechenden Fachklasse mitlaufen** zu lassen. Der BW-Vertrag hat dafür ein eigenes Feld.\n\nDas zahlt sich doppelt aus: Der Übergang in die Ausbildung fällt leichter, und eine spätere [[teilzeit-verkuerzung|Verkürzung]] wird plausibler. Bei schulpflichtigen Teilnehmenden die schulrechtliche Einordnung **früh** klären, nicht erst im November." },
      { t: "Geld: Zuschuss, Vergütung, Mindestlohn", d: 3, text: "Der Arbeitgeber kann einen Zuschuss zur vereinbarten Vergütung erhalten — **höchstens 276 Euro monatlich** (§ 54a Abs. 1 SGB III) — zuzüglich des pauschalierten Anteils am Gesamtsozialversicherungsbeitrag. Den **aktuellen Förderbetrag** veröffentlicht die BA gesondert; die tatsächlich gezahlte Vergütung kann höher liegen, tarifliche Regelungen sind einzuhalten. Der Zuschuss ist **vor Beginn** zu beantragen.\n\nDer **gesetzliche Mindestlohn gilt für die EQ nicht** (§ 22 Abs. 1 Satz 2 Nr. 4 MiLoG) — ebenso wenig für ein Orientierungspraktikum bis zu drei Monaten. Die [[mindestverguetung|Mindestausbildungsvergütung]] der regulären Ausbildung ist damit ausdrücklich **nicht** der Maßstab; über § 26 BBiG bleibt es aber bei einer **angemessenen** Vergütung.\n\nWährend der EQ besteht Versicherungspflicht in Kranken-, Pflege-, Renten- und Arbeitslosenversicherung sowie in der gesetzlichen Unfallversicherung. Bei Minderjährigen gilt das [[arbeitszeit-jugendliche|Jugendarbeitsschutzgesetz]] — im Gartenbau besonders bei Maschinen, Fahrzeugen, Pflanzenschutzmitteln und Arbeitszeiten." },
      { t: "Zeugnis, Zertifikat und der Weg in die Ausbildung", d: 3, text: "Nach § 54a Abs. 3 SGB III bescheinigt der Betrieb die vermittelten Fertigkeiten, Kenntnisse und Fähigkeiten. Empfohlen ist ein **betriebliches Zeugnis mit differenzierter Leistungsbeurteilung** — es ist die Grundlage für das **Zertifikat**, das die zuständige Stelle **auf Antrag des Arbeitgebers oder der teilnehmenden Person** ausstellt. Beide sind darauf hinzuweisen, dass sie es beantragen müssen; von allein kommt es nicht.\n\nEine erfolgreiche EQ führt **nicht automatisch** ins zweite Ausbildungsjahr. Richtig ist: Auszubildende und Ausbildende können nach **§ 8 Abs. 1 BBiG gemeinsam eine Verkürzung beantragen**; die zuständige Stelle kürzt, wenn zu erwarten ist, dass das Ausbildungsziel in der kürzeren Zeit erreicht wird. Der EQ-Vertrag sagt es selbst: Über die Anrechnung entscheidet die zuständige Stelle.\n\nSobald die reguläre Ausbildung beginnen soll, gelten die normalen Regeln vollständig — die Ausbildungsstätte muss nach **§ 27 Abs. 3 BBiG** anerkannt sein (für Gärtner/in nach der GartAusbStEignV), und es braucht einen persönlich und fachlich geeigneten [[ausbilder|Ausbilder]]. Ein Meistertitel ist dafür der klassische, aber nicht der einzige Weg (§ 30 BBiG). **Wer die EQ als Einstieg plant, klärt die Anerkennung am besten schon während der EQ** — sie braucht Vorlauf." },
      { t: "Vier Sätze, die in der Beratung häufig falsch fallen", d: 3, text: "**„Der Betrieb ist nicht anerkannt, also geht keine EQ.“** — Falsch. Die Eignung nach §§ 27–33 BBiG ist keine Fördervoraussetzung.\n\n**„Ohne Meister keine EQ.“** — Falsch. Eine formale Ausbildereignung nach §§ 28–30 BBiG verlangt die EQ nicht.\n\n**„Dann kann also jeder Betrieb eine EQ machen.“** — Ebenfalls falsch. Der Betrieb muss die vereinbarten Inhalte tatsächlich vermitteln können; bei Zweifeln holt die Agentur die Einschätzung der zuständigen Stelle ein.\n\n**„Nach der EQ bildet der Betrieb einfach weiter aus.“** — Falsch. Vor der regulären Ausbildung müssen Anerkennung der Ausbildungsstätte und Ausbildereignung vorliegen." }
    ],
    rollen: {
      azubi: "Eine EQ ist kein verlorenes Jahr, sondern ein Türöffner: vier bis zwölf Monate im Betrieb, mit Vergütung und Sozialversicherung. Geh möglichst in die Berufsschulklasse mit und führe den Ausbildungsnachweis von Anfang an — beides hilft dir, wenn es um den Ausbildungsvertrag und eine Verkürzung geht. Und denk daran: Das Zertifikat der zuständigen Stelle bekommst du nur auf Antrag.",
      betrieb: "Sie müssen für eine EQ weder anerkannter Ausbildungsbetrieb sein noch einen Meister beschäftigen. Beantragen Sie den Zuschuss **vor Beginn** bei der Agentur für Arbeit, kreuzen Sie mindestens drei Qualifizierungsbausteine an und reichen Sie den Vertrag 3-fach beim Regierungspräsidium ein. Wenn Sie danach ausbilden wollen: Anerkennung als Ausbildungsstätte und Ausbildereignung rechtzeitig während der EQ klären.",
      beratung: "Zuerst klären: echte EQ nach § 54a SGB III oder nur ein Praktikum? Danach nicht die Anerkennungsvoraussetzungen prüfen, sondern die Durchführbarkeit — Praktikumsleitung, tatsächliche Tätigkeiten, Bausteine, Dauer. Auf Substitution achten: Hat der Betrieb seine Ausbildungstätigkeit verringert und durch EQ-Plätze ersetzt? Die Einschätzung für die Agentur für Arbeit sauber begründen und den Maßstabsunterschied im Vermerk benennen."
    },
    faq: [
      { f: "Muss der Betrieb für eine Einstiegsqualifizierung anerkannter Ausbildungsbetrieb sein?", a: "Nein. Bei einer geförderten EQ nach § 54a SGB III ist die Eignung von Ausbildungsstätte und Ausbildungspersonal nach §§ 27–33 BBiG ausdrücklich **keine Fördervoraussetzung** — die Bundesagentur will damit auch nicht oder nicht mehr ausbildende Betriebe für die Ausbildung gewinnen. Fachlich muss der Betrieb die vereinbarten Qualifizierungsbausteine aber tatsächlich vermitteln können." },
      { f: "Braucht der Betrieb einen Gärtnermeister für die EQ?", a: "Nein. Weder ein Meistertitel noch eine formale Ausbildereignung nach §§ 28–30 BBiG ist für die EQ erforderlich. Der BW-Vertrag verlangt allerdings eine namentlich benannte **verantwortliche Praktikumsleitung** — jemand muss die Person im Alltag anleiten." },
      { f: "Wie lange dauert eine Einstiegsqualifizierung?", a: "Vier bis höchstens zwölf Monate, in Vollzeit oder in Teilzeit mit mindestens 20 Wochenstunden (§ 54a Abs. 2 SGB III). Mindestens 70 Prozent der Zeit müssen grundsätzlich im Betrieb stattfinden." },
      { f: "Wird die EQ auf die Ausbildung angerechnet?", a: "Nicht automatisch. „Zwölf Monate EQ = Einstieg ins zweite Lehrjahr“ ist falsch. Auszubildende und Ausbildende können nach § 8 Abs. 1 BBiG gemeinsam eine **Verkürzung beantragen**; die zuständige Stelle entscheidet, ob das Ausbildungsziel in der kürzeren Zeit zu erwarten ist. Ein Berufsschulbesuch während der EQ macht den Antrag deutlich plausibler." },
      { f: "Gilt für die EQ der Mindestlohn?", a: "Nein — § 22 Abs. 1 Satz 2 Nr. 4 MiLoG nimmt die Einstiegsqualifizierung ausdrücklich aus. Über § 26 BBiG bleibt es aber bei einer angemessenen Vergütung; die Agentur für Arbeit bezuschusst sie mit höchstens 276 Euro monatlich zuzüglich pauschaliertem Sozialversicherungsbeitrag." },
      { f: "Wo wird der EQ-Vertrag angezeigt?", a: "Bei der zuständigen Stelle — für Gärtner/in in Baden-Württemberg beim [[zustaendige-stelle|Regierungspräsidium]]. Es trägt den Vertrag in das **Verzeichnis der Praktikantenverhältnisse** ein. Diese Registrierung ist ausdrücklich **keine** Anerkennung des Betriebs als Ausbildungsstätte." },
      { f: "Wer stellt das Zertifikat über die EQ aus?", a: "Die zuständige Stelle — aber nur **auf Antrag** des Arbeitgebers oder der teilnehmenden Person, und nur gegen Vorlage des betrieblichen Zeugnisses. Beide Seiten sollten früh darauf hingewiesen werden, sonst bleibt am Ende nur das Betriebszeugnis." },
      { f: "Kann eine EQ auf eine Fachwerkerausbildung vorbereiten?", a: "Ja. § 54a Abs. 2 SGB III lässt die Förderung für Menschen mit Behinderungen ausdrücklich auch zu, wenn die EQ auf eine Ausbildung nach [[fw-grundlagen|§ 66 BBiG]] vorbereitet — im Gartenbau also auf die Fachwerkerausbildung." }
    ],
    verwandt: ["ausbildungsvertrag", "foerderung", "fw-grundlagen"]
  },

  {
    ...
    abschnitte: [
      ...
      { t: "Verlängerung in besonderen Fällen", d: 3, text: "Eine Verlängerung nach § 8 Abs. 2 BBiG kommt in Betracht bei längerer Krankheit, erheblichen Fehlzeiten oder wenn Förderbedarf besteht. Antragsberechtigt sind die **Auszubildenden** (bei Minderjährigen die gesetzlichen Vertreter); der Betrieb ist zu hören. Daneben verlängert sich die Ausbildung auf Verlangen automatisch [[nichtbestehen|nach nicht bestandener Abschlussprüfung]] (§ 21 Abs. 3 BBiG). Für Teilzeit-, Verkürzungs- und Verlängerungsberechnungen stehen die [[foerderung|Förderwege]] und die **Rechner im Schnellnachschlag** bereit." }
    ],
    rollen: {
    ...
    faq: [
      ...
      { f: "Geht eine Ausbildung auch in Teilzeit?", a: "Ja, seit 2020 für alle: Die tägliche oder wöchentliche Ausbildungszeit kann um bis zu 50 % gekürzt werden; die Gesamtdauer verlängert sich entsprechend, höchstens auf das Anderthalbfache (§ 7a BBiG). Bei Teilzeit darf die [[mindestverguetung|Vergütung]] anteilig angepasst werden." },
      { f: "Wer entscheidet über Verkürzung oder Verlängerung?", a: "Die [[zustaendige-stelle|zuständige Stelle]] — in Baden-Württemberg das Regierungspräsidium. Sie prüft den Antrag (bei Verkürzung den gemeinsamen Antrag von Betrieb und Azubi), hört die Beteiligten an und trägt die Änderung ins Verzeichnis ein." }
    ],
...

  {
    ...
    abschnitte: [
      ...
      { t: "Häufige Probleme", d: 3, text: "- **Monatelang nichts eingetragen:** Nacharbeiten ist mühsam und fällt bei der Zulassungsprüfung auf. Ausbilder sollten Rückstände früh ansprechen — das regelmäßige Durchsehen ist ihre Pflicht.\n- **Führen nur in der Freizeit verlangt:** unzulässig. Das Führen gehört seit 2020 ausdrücklich in die Ausbildungszeit (§ 14 Abs. 2 BBiG).\n- **Streit über die Form:** Maßgeblich ist die im [[ausbildungsvertrag|Ausbildungsvertrag]] festgelegte Form; eine Umstellung (z. B. auf digital) sollte schriftlich vereinbart und der zuständigen Stelle mitgeteilt werden." },
      { t: "Elektronisch führen", d: 3, text: "Der elektronische Ausbildungsnachweis ist dem Papierheft gleichgestellt: zulässig sind einfache Textdateien und Tabellen ebenso wie Berichtsheft-Apps — entscheidend ist, dass die **Form im Vertrag festgelegt** ist, Einträge **datiert und den Azubis zurechenbar** sind und die **Gegenzeichnung** (auch elektronisch, z. B. per Freigabe-Klick) nachvollziehbar bleibt. Die Vordrucke im [[eintragung|Download-Center der zuständigen Stelle]] lassen sich am Bildschirm ausfüllen; Software und Lizenzkosten zählen zu den kostenlosen [[ausbildungsmittel|Ausbildungsmitteln]]." },
      { t: "Woher das Berichtsheft kommt", d: 2, text: "Der Betrieb stellt das Heft, nicht die/der Azubi — und zwar **ab Ausbildungsbeginn**. Bezogen wird es je nach Fachrichtung an unterschiedlichen Stellen:\n\n- **Erwerbsgartenbau** (Baumschule, Friedhofsgärtnerei, Gemüsebau, Obstbau, Staudengärtnerei, Zierpflanzenbau): **kostenpflichtig** über die Förderungsgesellschaft Gartenbau mbH (FGG), Claire-Waldorff-Str. 7, 10117 Berlin, berichtsheft@derdeutschegartenbau.de, Tel. 030 200065-13 — oder im Internetshop g-plus.de/shop. Mitglieder der ZVG-Landesverbände und des Bundes deutscher Baumschulen zahlen **43,50 € netto**, Nichtmitglieder **53,50 € netto**, jeweils zuzüglich Versand.\n- **Garten- und Landschaftsbau, umlagepflichtig:** Der Betrieb schickt eine Kopie des von beiden Seiten unterschriebenen Ausbildungsvertrags an die AuGaLa in 53602 Bad Honnef (augala.de, Fax 02224 7707-938). Der Versand des Berichtshefts wird dann **kostenlos** veranlasst.\n- **Garten- und Landschaftsbau, nicht umlagepflichtig** (etwa Kommunen und Bildungsträger): über die GaLaBau-Service GmbH (GBS), 53602 Bad Honnef, Tel. 02224 7707-14, Fax 02224 7707-914 (galabau.de), zuzüglich Versandkosten.\n\nDie im Hinweisblatt genannten Ansprechpartnerinnen stehen dort namentlich — die aktuelle Fassung liegt im Download-Center. Wichtig für die Beratung: Der **Bezug kostet den Betrieb Geld, das Heft die Auszubildenden nichts**. Wer im GaLaBau umlagepflichtig ist, bekommt es ohnehin nur über den eingereichten Vertrag." }
    ],
    rollen: {
    ...
    faq: [
      { f: "Woher bekommt der Betrieb das Berichtsheft?", a: "Im **Erwerbsgartenbau** kostenpflichtig über die Förderungsgesellschaft Gartenbau mbH (FGG, Berlin) oder deren Internetshop g-plus.de/shop — 43,50 € netto für Mitglieder der ZVG-Landesverbände und des Bundes deutscher Baumschulen, 53,50 € netto für Nichtmitglieder, jeweils zuzüglich Versand. Im **Garten- und Landschaftsbau** genügt bei umlagepflichtigen Betrieben eine Kopie des unterschriebenen Ausbildungsvertrags an die AuGaLa (Bad Honnef); das Heft kommt dann kostenlos. Nicht umlagepflichtige Betriebe — etwa Kommunen und Bildungsträger — wenden sich an die GaLaBau-Service GmbH. Für die Auszubildenden ist das Heft in jedem Fall kostenlos (§ 14 Abs. 1 Nr. 3 BBiG)." },
      { f: "Reichen Tagesberichte für die Prüfungszulassung?", a: "Ja — die **regelmäßig geführten Tagesberichte** sind die Mindestanforderung für die Zulassung zur Abschlussprüfung. Sie dürfen elektronisch geführt werden, müssen dann aber **ausgedruckt und von Ausbilder/in und Azubi unterschrieben** werden. Wer mehr will, kann das vollständige Führen des Berichtshefts über eine **Zusatzvereinbarung zum Ausbildungsvertrag** rechtsverbindlich vereinbaren." },
      ...
      { f: "Was passiert, wenn das Berichtsheft fehlt oder unvollständig ist?", a: "Ohne ordnungsgemäß geführten Ausbildungsnachweis wirst du nicht zur [[abschlusspruefung|Abschlussprüfung]] zugelassen (§ 43 Abs. 1 Nr. 2 BBiG). Lücken solltest du deshalb früh nacharbeiten — und der Betrieb muss dich dabei unterstützen." }
    ],
...

  {
    ...
    abschnitte: [
      ...
      { t: "Wenn der Betrieb vom Schulbesuch abhält", d: 3, text: "Immer wieder verlangen Betriebe, bei Personalengpässen statt der Schule zu arbeiten. Das ist **unzulässig**: Die [[freistellung|Freistellungspflicht]] des § 15 BBiG ist zwingend; Verstöße sind eine Ordnungswidrigkeit (§ 102 BBiG) und ein klassischer Fall für die [[ausbildungsberatung|Ausbildungsberatung]]. Azubis geraten dabei in eine Zwickmühle — sie sollten den Konflikt nicht selbst austragen, sondern die Beratung einschalten." }
    ],
    rollen: {
    ...
    faq: [
      ...
      { f: "Darf mein Chef mich statt zur Schule in den Betrieb holen?", a: "Nein. Der Betrieb muss dich für den Berufsschulunterricht [[freistellung|freistellen]] (§ 15 BBiG). Ein Verstoß ist eine Ordnungswidrigkeit — wende dich an die Ausbildungsberatung." },
      { f: "Zählt der Weg zwischen Schule und Betrieb zur Ausbildungszeit?", a: "Ja — angerechnet werden Unterrichtszeit einschließlich Pausen sowie die Wegezeit zwischen Berufsschule und Betrieb. Details und Rechenbeispiele stehen im Artikel [[freistellung|Freistellung & Anrechnung]]." }
    ],
...

  {
    ...
    abschnitte: [
      ...
      { t: "Fehlzeiten und Prüfungszulassung", d: 3, text: "Für die Zulassung zur [[abschlusspruefung|Abschlussprüfung]] muss die Ausbildungszeit „zurückgelegt“ sein (§ 43 BBiG). Als Faustregel der Praxis gelten Fehlzeiten von **mehr als etwa 10 %** der Ausbildungszeit als kritisch — entscheidend ist der Einzelfall (Lage, Gründe, Leistungsstand). Bei absehbar hohen Fehlzeiten (lange Krankheit, Reha): früh mit der zuständigen Stelle sprechen; eine [[teilzeit-verkuerzung|Verlängerung nach § 8 Abs. 2 BBiG]] sichert den Abschluss. Wie gezählt und bewertet wird, welche Unterlagen die Entscheidung tragen und wer sie trifft, steht ausführlich unter [[fehlzeiten-zulassung|Fehlzeiten & Zulassung zur Abschlussprüfung]].", },
    ...
    faq: [
      ...
      { f: "Bekomme ich als Azubi Geld, wenn ich krank bin?", a: "Ja — deine Ausbildungsvergütung läuft bei Arbeitsunfähigkeit bis zu sechs Wochen weiter (§ 3 EFZG, § 19 BBiG), wenn dein Ausbildungsverhältnis schon mindestens vier Wochen besteht. Danach zahlt die Krankenkasse Krankengeld. Details im Artikel [[fortzahlung|Fortzahlung der Vergütung]]." },
  ...
  /* =================== Pflichten der Ausbildenden =================== */
  {
    ...
    abschnitte: [
      ...
      { t: "Konsequenzen bei Verstößen", d: 3, text: "Wird planwidrig oder ausbildungsfremd „ausgebildet“, kann die [[ausbildungsberatung|zuständige Stelle]] beraten, **Auflagen** machen und Fristen setzen (§ 76 BBiG); bei fortgesetzten schweren Mängeln kommt die **Untersagung des Einstellens und Ausbildens** durch die zuständige Behörde in Betracht (§ 33 BBiG). Azubis können aus wichtigem Grund [[kuendigung|kündigen]] (§ 22 Abs. 2 Nr. 1 BBiG) und haben dann ggf. einen **Schadensersatzanspruch** (§ 23 BBiG)." }
    ],
    rollen: {
    ...
    faq: [
      { f: "Darf ich als Azubi zum Putzen und Kehren eingeteilt werden?", a: "Gelegentlich ja — das gehört zum Betriebsalltag. Unzulässig wird es, wenn solche ausbildungsfremden Tätigkeiten deine Ausbildung prägen und du die eigentlichen Inhalte nicht lernst (§ 14 BBiG). Dein [[berichtsheft|Berichtsheft]] belegt das — und die [[ausbildungsberatung|Ausbildungsberatung]] hilft." },
...

  {
    ...
    abschnitte: [
      ...
      { t: "Wenn die Ausbilderin/der Ausbilder ausfällt", d: 3, text: "Scheidet die Ausbilderin/der Ausbilder aus oder fällt länger aus, muss der Betrieb **unverzüglich** eine geeignete Nachfolge benennen und der [[zustaendige-stelle|zuständigen Stelle]] melden. Gelingt das nicht in angemessener Zeit, ist die ordnungsgemäße Ausbildung nicht mehr gesichert — die zuständige Stelle berät zu Lösungen (externe Ausbilder, Verbund, Betriebswechsel der Azubis) und muss notfalls die Eignung der Ausbildungsstätte neu bewerten. Die Meldung fließt in das [[eintragung|Verzeichnis]] ein." }
    ],
    rollen: {
...

  {
    ...
    abschnitte: [
      { t: "Typische Streitfälle", d: 2, text: "- **Berufsschulbücher/Lernmittel:** Materialien für den Schulunterricht sind keine betrieblichen Ausbildungsmittel; hier gelten die schulischen Lernmittelregeln. Fachliteratur, die der **Betrieb** für die Ausbildung voraussetzt, zahlt der Betrieb.\n- **Prüfungsmaterial:** Werkstoffe und Pflanzen für Prüfungsstücke sind seit der BBiG-Reform 2020 ausdrücklich erfasst — der Betrieb stellt sie für die [[abschlusspruefung|Prüfungen]] kostenlos.\n- **Werkzeugverlust:** Bei leicht fahrlässigem Verlust haften Azubis nicht oder nur anteilig — es gelten die Grundsätze des innerbetrieblichen Schadensausgleichs aus dem Artikel [[lernpflicht|Lernpflicht & Sorgfalt]].\n- **Fahrtkosten** zur Berufsschule oder zu Lehrgängen: keine Ausbildungsmittel; ggf. Tarifvertrag, [[foerderung|Förderprogramme]] oder Zuschüsse prüfen." }
    ],
    rollen: {
    ...
    faq: [
      ...
      { f: "Darf der Betrieb Lehrgangskosten zurückverlangen, wenn ich abbreche?", a: "Nein — Vereinbarungen, die Azubis zur Erstattung von Ausbildungskosten verpflichten, sind nach § 12 BBiG nichtig. Solche Klauseln beanstandet die zuständige Stelle schon bei der Vertragsprüfung; mehr dazu im Artikel [[ausbildungsvertrag|Berufsausbildungsvertrag]]." }
    ],
...

  {
    ...
    abschnitte: [
      ...
      { t: "Jugendliche: strengere Regeln", d: 3, text: "Für unter 18-Jährige gilt § 9 JArbSchG: Ein Berufsschultag mit mehr als 5 Unterrichtsstunden wird generell mit 8 Stunden angerechnet (einmal pro Woche), Blockwochen mit 40 Stunden. Nach dem Unterricht dürfen Jugendliche an solchen Tagen **nicht mehr beschäftigt** werden. Für Prüfungen gilt § 10 JArbSchG: Freistellung auch **am Arbeitstag unmittelbar vor der schriftlichen Abschlussprüfung**. Die übrigen Zeitgrenzen stehen im Artikel [[arbeitszeit-jugendliche|Arbeitszeit für Jugendliche]]." },
...

  {
    ...
    abschnitte: [
      ...
      { t: "Abgrenzung: Zeugnisse und Bescheinigungen", d: 3, text: "- **Ausbildungszeugnis des Betriebs** (§ 16 BBiG) — hier behandelt\n- **Prüfungszeugnis der zuständigen Stelle** (§ 37 Abs. 2 BBiG) — dokumentiert das Ergebnis der [[abschlusspruefung|Abschlussprüfung]]\n- **Berufsschulzeugnis** der Schule\n\nAlle drei sind eigenständig. Endet die Ausbildung vorzeitig — etwa durch [[kuendigung|Kündigung]] oder [[aufhebung|Aufhebungsvertrag]] — besteht der Anspruch auf das betriebliche Zeugnis ebenso, ohne negative Hinweise auf den Beendigungsgrund." }
    ],
    rollen: {
  ...
  /* =================== Vergütung & Geld ============================= */
  {
    ...
    faq: [
      ...
      { f: "Darf mein Betrieb Kost und Wohnung vom Gehalt abziehen?", a: "Anrechnen ja — aber nur zu den amtlichen Sachbezugswerten und höchstens bis 75 % der Bruttovergütung (§ 17 Abs. 6 BBiG). Ein Rest von mindestens 25 % ist immer auszuzahlen. Details im Artikel [[sachbezuege-sozialvers|Abrechnung & Sachbezüge]]." },
      { f: "Steigt meine Vergütung, wenn die Mindestvergütung erhöht wird?", a: "Nicht automatisch — für die gesetzliche Mindestvergütung bleibt das **Jahr deines Ausbildungsbeginns** maßgeblich; spätere Erhöhungen gelten für neue Jahrgänge. Deine Vergütung steigt aber mit jedem Ausbildungsjahr (Staffel) und bei Tarifbindung mit jeder Tariferhöhung. Unabhängig davon muss sie immer „angemessen“ bleiben (§ 17 Abs. 1 BBiG)." }
    ],
...

  {
    ...
    abschnitte: [
      { t: "Saisonspitzen im Gartenbau", d: 2, text: "Frühjahr und Ernte bringen lange Tage — trotzdem gilt: Bei **volljährigen** Azubis ([[arbeitszeit-erwachsene|ArbZG-Grenzen]]) sind gelegentliche Überstunden nur mit Ausgleich (Geld oder Freizeit) zulässig und sollten die Ausnahme bleiben. Bei **Jugendlichen** ([[arbeitszeit-jugendliche|JArbSchG-Grenzen]]) erlaubt § 8 Abs. 2 JArbSchG in der Landwirtschaft zur Erntezeit für über 16-Jährige bis zu 9 Stunden täglich und 85 Stunden in der Doppelwoche — der Ausgleich auf durchschnittlich 40 Wochenstunden ist zwingend. Dauerhafte Überstunden sind ein Warnsignal für die Ausbildungsqualität." },
...

  {
    ...
    fakten: [
      "[[freistellung|Freistellungen]] (Berufsschule, Prüfungen, Tag vor der schriftlichen Abschlussprüfung): Vergütung läuft weiter (§ 19 Abs. 1 Nr. 1 BBiG).",
      "**Krankheit:** bis zu **6 Wochen** volle Vergütung (§ 3 EFZG) — die Meldepflichten stehen im Artikel [[krankmeldung|Krankmeldung]] —, danach Krankengeld.",
    ...
    abschnitte: [
      { t: "Der Sonderfall Schlechtwetter", d: 2, text: "Im Gartenbau relevant: Fällt die Ausbildung wegen Frost, Dauerregen oder Auftragslage aus, tragen **nicht die Azubis** das Risiko. Der Betrieb muss die Vergütung bis zu sechs Wochen fortzahlen (§ 19 Abs. 1 Nr. 2 BBiG) — unbezahlte „Zwangspausen“ oder das Abbummeln von Ausfallzeiten zulasten des [[urlaub|Urlaubs]] sind unzulässig. Sinnvoll: Ausfallzeiten für Theorie, Maschinenpflege, [[berichtsheft|Berichtsheft]] und Prüfungsvorbereitung nutzen." },
...

  {
    ...
    abschnitte: [
      ...
      { t: "Weitere Leistungen und Förderungen", d: 3, text: "- **Vermögenswirksame Leistungen**: je nach Tarifvertrag\n- **Berufsausbildungsbeihilfe (BAB)** der Agentur für Arbeit: bei auswärtiger Unterbringung und geringem Einkommen — früh beantragen; Überblick im Artikel [[foerderung|Förderwege]]\n- **Wohn-/Fahrtkostenzuschüsse**: regionale Programme und ggf. tarifliche Regelungen prüfen\n- **Deutschlandticket/Jugendtickets**: Landes-/Verbundangebote für Azubis nutzen\n\nDie [[ausbildungsberatung|Ausbildungsberatung]] kennt die üblichen Anlaufstellen und verweist weiter." }
    ],
    rollen: {
    ...
    faq: [
      ...
      { f: "Wie viel darf der Betrieb für Zimmer und Verpflegung abziehen?", a: "Nur die amtlichen Sachbezugswerte, und insgesamt dürfen Sachleistungen höchstens 75 % deiner Bruttovergütung ausmachen (§ 17 Abs. 6 BBiG) — mindestens 25 % müssen ausgezahlt werden. Die Untergrenzen der Vergütung selbst stehen im Artikel [[mindestverguetung|Mindestausbildungsvergütung]]." },
      { f: "Zahle ich als Azubi Lohnsteuer?", a: "Nur, wenn deine Vergütung über dem steuerlichen Grundfreibetrag liegt — bei typischen Ausbildungsvergütungen fällt in Steuerklasse I meist keine oder kaum Lohnsteuer an. Sozialversicherungsbeiträge werden dagegen ab dem ersten Euro fällig (Ausnahme: bis 325 € trägt sie der Betrieb allein). Ein Blick auf die Abrechnung lohnt trotzdem." }
    ],
  ...
  /* =================== Arbeitszeit, Pausen & Urlaub ================= */
  {
    ...
    abschnitte: [
      { t: "Vertragliche vs. gesetzliche Arbeitszeit", d: 2, text: "Das ArbZG setzt nur die **Obergrenzen**. Wie lange tatsächlich ausgebildet wird, bestimmen Vertrag und Tarif — Mehrzeit darüber hinaus ist Thema des Artikels [[ueberstunden|Überstunden & Mehrarbeit]] (§ 17 Abs. 7 BBiG). Wichtig für die Praxis: Auch in der Saison bleiben die 10-Stunden-Grenze, die Pausen und die 11-Stunden-Ruhezeit hart — sie schützen vor Übermüdung und Unfällen, gerade beim Maschineneinsatz." },
...

  {
    ...
    fakten: [
      ...
      "**Im Gartenbau liegt der Tarif unter der gesetzlichen Grenze:** Garten- und Landschaftsbau **39 Stunden** (allgemeinverbindlich), Produktionsgartenbau **39,5 Stunden** je Woche — der Vertrag darf die 40 Stunden des JArbSchG also gar nicht ausschöpfen.",
...

  {
    ...
    abschnitte: [
      ...
      { t: "Urlaubsentgelt ist nicht Urlaubsgeld", d: 3, text: "Zwei Begriffe, die oft verwechselt werden:\n\n- **Urlaubsentgelt** = die normale [[fortzahlung|Fortzahlung der Vergütung]] während des Urlaubs. Sie steht jeder/jedem Azubi kraft Gesetzes zu.\n- **Urlaubsgeld** = eine **zusätzliche** Zahlung zum Urlaub. Sie gibt es nur, wenn Tarifvertrag, Betriebsvereinbarung oder Ausbildungsvertrag sie vorsehen — ein gesetzlicher Anspruch besteht nicht.\n\nWer wissen will, ob Urlaubsgeld zusteht: in den [[ausbildungsvertrag|Vertrag]] und den anwendbaren Tarifvertrag schauen; die Ausbildungsberatung hilft beim Einordnen." },
      { t: "Typische Konflikte", d: 3, text: "- **„Urlaub nur im Winter“:** Saisonbetriebe dürfen lenken, aber nicht den gesamten Anspruch faktisch entwerten; die Ferienbindung für Berufsschüler bleibt zu beachten.\n- **Urlaubssperre in der Blockschulzeit:** [[berufsschulpflicht|Blockunterricht]] ist keine Urlaubszeit — Urlaub während der Schule ist unzulässig.\n- **Krank im Urlaub:** Attest ab dem ersten Tag sichern, Tage werden gutgeschrieben (§ 9 BUrlG) — Meldewege im Artikel [[krankmeldung|Krankmeldung]].\n- **Verfall:** Der Betrieb muss auf drohenden Verfall **hinweisen** — ohne Hinweis verfällt Urlaub nach der Rechtsprechung nicht ohne Weiteres." }
    ],
    rollen: {
...

  {
    ...
    fakten: [
      "**Zulassung** (§ 43): Ausbildungszeit zurückgelegt (oder Ende innerhalb von 2 Monaten nach dem Prüfungstermin), [[zwischenpruefung|Zwischenprüfung]] absolviert, [[berichtsheft|Ausbildungsnachweis]] geführt, Vertrag [[eintragung|eingetragen]].",
      ...
      "**Anmeldeschluss in Baden-Württemberg:** **1. November** für die Winterprüfung, **1. April** für die Sommerprüfung — gilt auch für Wiederholende und für die [[abschlusspruefung|Externenprüfung]] nach § 45 Abs. 2 BBiG. Verspätete Anmeldungen rutschen in den nächsten Durchgang.",
    ...
    abschnitte: [
      ...
      { t: "Wenn die Zulassung wackelt", d: 3, text: "Häufigste Stolpersteine:\n\n- [[berichtsheft|Berichtsheft unvollständig]] → rechtzeitig nacharbeiten und gegenzeichnen lassen; ohne Nachweis keine Zulassung\n- **hohe Fehlzeiten** → Einzelfallentscheidung der zuständigen Stelle; ggf. [[teilzeit-verkuerzung|Verlängerung beantragen]] statt Nichtzulassung riskieren ([[fehlzeiten-zulassung|Zählweise, Richtwerte und Unterlagen im Detail]])\n- [[zwischenpruefung|fehlende Zwischenprüfung]] → Nachholtermin klären\n- Vertrag nicht [[eintragung|eingetragen]] → sofort mit der zuständigen Stelle klären\n\nGegen eine ablehnende Zulassungsentscheidung ist rechtliches Gehör und der Verwaltungsrechtsweg eröffnet — meist lässt sich vorher eine Lösung finden." },
      { t: "Rund um den Prüfungstag", d: 3, text: "- **Krank am Prüfungstag:** sofort Attest besorgen und die zuständige Stelle informieren — dann gilt die Prüfung als nicht unternommen und wird nachgeholt.\n- **Rücktritt/Abbruch** ohne wichtigen Grund: Die Prüfung gilt als nicht bestanden — danach gelten die Regeln aus [[nichtbestehen|Prüfung nicht bestanden]].\n- [[foerderung|Nachteilsausgleich]] (§ 65 BBiG) für Menschen mit Behinderung **vorab beantragen** (z. B. Zeitzuschlag, Hilfsmittel).\n- Ergebnis und **Prüfungszeugnis** stellt die zuständige Stelle aus; das [[zeugnis|Ausbildungszeugnis des Betriebs]] kommt zusätzlich." },
      { t: "Der schriftliche Teil läuft gemeinsam mit der Berufsschule", d: 2, text: "Der schriftliche Teil der Abschlussprüfung wird als **gemeinsame schriftliche Abschlussprüfung von Berufsschule und Wirtschaft** geschrieben — landeseinheitlich, gesteuert von der Koordinierungsstelle am Institut für Bildungsanalysen (IBBW). Die Schulen bestellen die Aufgabensätze im elektronischen Prüfungsmanagement ePM (iKOOS); die Sätze kommen versiegelt und dürfen erst zum Prüfungsbeginn geöffnet werden.\n\nFür die Beratung zählen vor allem drei Dinge:\n\n- **Externe Prüfungsteilnehmende schreiben mit.** Wer über § 45 Abs. 2 BBiG zur [[abschlusspruefung|Externenprüfung]] zugelassen ist, nimmt an derselben schriftlichen Prüfung teil. Die **Zulassung spricht die zuständige Stelle aus** — eine gesonderte Zulassung durch die Berufsschule braucht es nicht. Namen und Anschriften gehen von der zuständigen Stelle an die Schulen.\n- **Zwischen Prüfungstag und Ergebnis liegt Zeit.** Die Schulen liefern die Ergebnisse bis zu einem festen Eingangsdatum an die zuständigen Stellen; entlassen werden die Prüfungsteilnehmenden frühestens einen Tag danach.\n- **Die Winterprüfung wandert.** Ab dem Schuljahr **2027/2028** finden die Prüfungen im Bereich Haus- und Landwirtschaft dauerhaft im **November** statt, der Januartermin entfällt. Der Anmeldeschluss 1. November bleibt davon unberührt — er liegt dann unmittelbar vor der Prüfung des Folgejahrgangs.\n\nDer Durchgang **Winter 2026/2027** wird am **12. und 13. Januar 2027** geschrieben (Gemeinschaftskunde, Deutsch, Wirtschafts- und Sozialkunde für alle Berufe; berufsbezogene Bereiche am zweiten Tag), Noteneingang bei den zuständigen Stellen bis **17. Februar 2027**. Für Gärtner/in im Garten- und Landschaftsbau sind das **Betriebliche Zusammenhänge** (90 Minuten) und **Pflanzenkenntnisse** (40 Minuten). Vorschau: Sommer 2027 am 10./11. Mai, Fachwerker- und Helferberufe am 22./23. Juni, Winter 2027 bereits am **9./10. November 2027**." },
      { t: "Wie korrigiert und bewertet wird", d: 3, text: "Die Korrektur- und Bewertungsrichtlinien der Koordinierungsstelle sind **verbindlich** — auch für die Beratung nützlich, wenn Prüflinge ihr Ergebnis nicht nachvollziehen können:\n\n- **Erstkorrektur rot** (Fehler unterstreichen, Korrekturzeichen an den rechten Rand), **Zweitkorrektur grün** über den linken Rand; die Zweitkorrektur kennzeichnet nur, was übersehen wurde oder anders bewertet wird.\n- **Bemerkungen, Noten oder Handzeichen der Lehrkraft sind nicht zulässig**, und die Korrekturpunkte werden **nicht in die Arbeit eingetragen** — das sichert die Unabhängigkeit beider Korrekturen.\n- Vergeben werden nur **ganze und halbe Punkte**. Für Verstöße gegen Form, Gliederung und Sprache dürfen insgesamt bis zu **10 %** der erreichten Punktzahl abgezogen werden. Ein **Denkfehler** kostet mindestens 50 % der Teilpunkte; Rechen-, Grafik-, Symbol- und Fachsprachfehler höchstens zwei Punkte.\n- **Abweichende Lösungen sind anzuerkennen**, wenn sie der Aufgabenstellung entsprechen und fachlich richtig sind — der amtliche Lösungsvorschlag ist keine Schablone.\n- Die Punkte werden auf einen **100-Punkte-Schlüssel** umgerechnet und über eine feste Tabelle in eine Dezimalnote überführt (100 Punkte = 1,0; 50 = 3,5; 20 = 5,0; 0 = 6,0).\n\n**Pflanzenbestimmung** (mit dem MLR abgestimmt): In der Regel 20 Pflanzen, je **2 Punkte** — einer für den botanischen Namen (Gattung und Art), einer für den deutschen. Die Familie wird nicht verlangt. Rechtschreibfehler kosten **50 % des jeweiligen Teils**: „Corylus awelana, Gemeine Hasel“ ergibt 1,75 von 2 Punkten, ein falscher deutscher Name streicht dessen Punkt ganz." },
    ],
    rollen: {
    ...
    faq: [
      ...
      { f: "Bis wann muss zur Abschlussprüfung angemeldet werden?", a: "In Baden-Württemberg gelten feste Anmeldeschlüsse: **1. November** für die Winterprüfung und **1. April** für die Sommerprüfung. Das gilt für die reguläre Anmeldung durch den Betrieb ebenso wie für Wiederholende und externe Prüfungsteilnehmende. Wer die Frist verpasst, kann erst im nächsten Durchgang antreten — deshalb Berichtsheft, Zwischenprüfung und Eintragung rechtzeitig davor prüfen." },
      { f: "Kann ich die Abschlussprüfung ohne Ausbildung machen?", a: "Ja — über die Externenprüfung nach § 45 Abs. 2 BBiG. Voraussetzung ist, dass du mindestens das Anderthalbfache der Ausbildungsdauer einschlägig gearbeitet hast, bei drei Jahren Ausbildung also 4,5 Jahre (auch mit Abitur, es gibt hier keine Verkürzung). Wird die Zeit nicht ganz erreicht, kann sie entfallen, wenn du die berufliche Handlungsfähigkeit glaubhaft machst; Tätigkeiten und Abschlüsse aus dem Ausland zählen mit. Einzureichen sind formloser Antrag, Anmeldebogen, Nachweise über alle einschlägigen Tätigkeiten, Lebenslauf und das letzte Schulzeugnis." },
      { f: "Muss ich als externe Prüfungsteilnehmerin ein Berichtsheft vorlegen?", a: "Nein. Bei der Externenprüfung nach § 45 Abs. 2 BBiG entfallen Berichtsheft und Nachweis überbetrieblicher Lehrgänge (z. B. DEULA) — verlangt werden der Zulassungsantrag, der Anmeldebogen, Nachweise über sämtliche einschlägigen Tätigkeiten, ein tabellarischer Lebenslauf und das letzte Schulzeugnis. Auch die Berufsschule wird vorher nicht besucht; ohne Ausbildungsvertrag ist das gar nicht möglich." },
      { f: "Wie läuft die Externenprüfung im Gartenbau ab?", a: "Wie die reguläre Prüfung: fünf praktische Aufgaben (zusammen 3,5–4,5 Stunden), Pflanzenbestimmung (20 Pflanzen in 20 Minuten) und 60 Minuten mündliche Prüfung; die drei schriftlichen Bereiche (Betriebliche Zusammenhänge, Wirtschafts- und Sozialkunde, Pflanzenkenntnisse) werden vorher an der Berufsschule geschrieben und fließen ins Abschlusszeugnis ein. Das Niveau entspricht dem der Gesellenprüfung." },
      { f: "Endet meine Ausbildung mit der bestandenen Prüfung?", a: "Ja — mit Bekanntgabe des Ergebnisses endet das Ausbildungsverhältnis, auch wenn der Vertrag eigentlich länger liefe (§ 21 Abs. 2 BBiG). Arbeitest du danach einfach weiter, entsteht ein unbefristetes Arbeitsverhältnis (§ 24 BBiG) — mehr im Artikel [[ende-uebernahme|Ende & Übernahme]]." }
    ],
    verwandt: ["zwischenpruefung", "nichtbestehen", "ende-uebernahme"]
  },

  {
    id: "fehlzeiten-zulassung",
    thema: "schule-pruefung",
    titel: "Fehlzeiten & Zulassung zur Abschlussprüfung",
    kurz: "Hohe Fehlzeiten schließen niemanden automatisch von der Abschlussprüfung aus. Sie lösen aber eine genauere Prüfung aus, ob genug Ausbildung stattgefunden hat — bewertet werden Umfang und Lage der Ausfälle zusammen mit dem erreichten Ausbildungsstand.",
    stichworte: ["Fehlzeiten", "Fehltage", "krank", "Krankheit", "Zulassung", "10 Prozent", "66 Tage", "75 Tage", "Nichtzulassung", "Verlängerung", "Ausbildungsstand", "Nachholplan", "Stellungnahme"],
    recht: [
      { n: "§ 43 BBiG", t: "Zulassung zur Abschlussprüfung" },
      { n: "§ 46 BBiG", t: "Entscheidung über die Zulassung" },
      { n: "§ 8 Abs. 2 BBiG", t: "Verlängerung auf Antrag" },
      { n: "§ 21 Abs. 3 BBiG", t: "Verlängerung nach nicht bestandener Prüfung" },
      { n: "§ 15 BBiG", t: "Freistellung und Anrechnung" }
    ],
    fakten: [
      "**Das BBiG nennt keine Höchstzahl an Fehltagen.** Weder 66 noch 75 Tage stehen im Gesetz, und auch die 10 % sind dort nicht als Grenze verankert.",
      "§ 43 Abs. 1 BBiG verlangt, dass die **Ausbildungsdauer zurückgelegt** ist — gemeint ist nicht nur der Kalender, sondern dass die Ausbildung im Wesentlichen **tatsächlich stattgefunden** hat.",
      "In der Zulassungspraxis gelten Fehlzeiten bis etwa **10 % der maßgeblichen Ausbildungszeit** als geringfügig; darüber wird im Einzelfall bewertet.",
      "**Entschuldigt heißt nicht folgenlos:** Eine ärztliche Bescheinigung erklärt den Ausfall, ersetzt aber nicht die ausgefallene Ausbildung.",
      "**Berufsschule und überbetriebliche Lehrgänge sind selbst Ausbildungszeit** (§ 15 BBiG) — wer dort ist, fehlt nicht. Nur tatsächlich versäumte Tage zählen.",
      "Entschieden wird von der **zuständigen Stelle**; hält sie die Voraussetzungen für nicht gegeben, entscheidet der **Prüfungsausschuss** (§ 46 Abs. 1 BBiG). Der Betrieb liefert eine Einschätzung, keine Entscheidung.",
      "Reicht die Zeit für fehlende Inhalte nicht, kommt eine **[[teilzeit-verkuerzung|Verlängerung nach § 8 Abs. 2 BBiG]]** in Betracht — **auf Antrag der Auszubildenden**, der Betrieb wird nur angehört.",
      "**Nichtzulassung ist etwas anderes als Nichtbestehen** — der Verlängerungsanspruch aus § 21 Abs. 3 BBiG gilt nur nach einer nicht bestandenen Prüfung."
    ],
    abschnitte: [
      { t: "Was § 43 BBiG wirklich verlangt", d: 2, text: "Zur Abschlussprüfung ist zuzulassen, wer\n\n- die **Ausbildungsdauer zurückgelegt** hat oder dessen Ausbildungsdauer spätestens **zwei Monate nach dem Prüfungstermin** endet,\n- an der vorgeschriebenen [[zwischenpruefung|Zwischenprüfung]] teilgenommen und den [[berichtsheft|Ausbildungsnachweis]] über den Betrieb vorgelegt hat und\n- dessen Ausbildungsverhältnis **[[eintragung|eingetragen]]** ist (oder aus einem Grund nicht, den weder Azubi noch gesetzliche Vertreter zu vertreten haben).\n\nDer erste Punkt ist der, an dem Fehlzeiten hängen. „Zurückgelegt“ meint nicht bloß, dass die Vertragszeit im Kalender abgelaufen ist — die Ausbildung muss im Wesentlichen auch **stattgefunden** haben. Deshalb können umfangreiche Ausfälle selbst dann eine Rolle spielen, wenn sie vollständig entschuldigt waren.\n\nEine Sonderregel gilt für **Menschen mit Behinderungen**: Nach § 65 Abs. 2 Satz 2 BBiG sind sie zur Abschlussprüfung auch dann zuzulassen, wenn die Voraussetzungen nach § 43 Abs. 1 Nr. 2 und 3 nicht vorliegen." },
      { t: "Der 10-%-Richtwert — und was er nicht ist", d: 2, text: "Fehlzeiten bis etwa **10 % der maßgeblichen Ausbildungszeit** bleiben bei der Zulassung in der Regel unberücksichtigt; so beschreibt es auch die Gartenbau-Ausbildungsberatung des Landwirtschaftsamts Karlsruhe. Oberhalb davon wird genauer hingesehen.\n\nDrei Missverständnisse dazu:\n\n- Der Richtwert ist **kein Anspruch** auf eine bestimmte Zahl freier Fehltage.\n- Er ist **keine automatische Ablehnungsgrenze** — über 10 % heißt „genauer prüfen“, nicht „nicht zugelassen“.\n- Er bezieht sich auf die **gesamte maßgebliche Ausbildungszeit**, nicht nur auf das letzte Ausbildungsjahr.\n\n**Woher die oft genannten 66 Tage kommen:** Rechnet man pauschal mit 220 Ausbildungstagen im Jahr, ergeben drei Ausbildungsjahre 660 Tage — davon 10 % sind 66 Tage. Diese Rechenweise verwenden zum Beispiel Industrie- und Handelskammern; sie ist für die Gärtnerausbildung **keine verbindliche Berechnungsvorgabe**. Bei Verkürzung, Teilzeit, angerechneten Zeiten oder einem früheren Bewertungsstichtag ist die Bezugsgröße eine andere. Welcher Zeitraum im konkreten Fall gilt, klärt die zuständige Stelle." },
      { t: "Örtliche Praxis in Freiburg: 66 und 75 Tage", d: 2, text: "Für den Beratungsablauf der Ausbildungsberatung Gartenbau am **Regierungspräsidium Freiburg** gelten diese Orientierungswerte (reguläre dreijährige Ausbildung):\n\n- **bis etwa 10 %, im genannten Modell rund 66 Tage** — in der Regel keine vertiefte Fehlzeitenprüfung, sofern die übrigen Voraussetzungen vorliegen\n- **ab etwa 66 Tagen bzw. über 10 %** — genauere Prüfung der Ausfälle und des erreichten Ausbildungsstands\n- **mehr als 75 Tage** — der Prüfungsausschuss befasst sich mit der Zulassungsentscheidung\n\n**Quellenstatus:** Das ist eine **örtliche Praxisangabe der Ausbildungsberatung des RP Freiburg (Stand 15.09.2026)** — keine landesweit veröffentlichte Vorschrift. Für die 75-Tage-Schwelle ließ sich keine öffentlich zugängliche Regelung finden. Wer sich darauf beruft, sollte das wissen und die Werte nicht als Rechtsnorm zitieren.\n\nUnabhängig von dieser Staffelung gilt **§ 46 Abs. 1 BBiG**: Hält die zuständige Stelle die Zulassungsvoraussetzungen für nicht gegeben, entscheidet der Prüfungsausschuss — das kann auch bei **weniger** als 75 Fehltagen der Fall sein." },
      { t: "Welche Zeiten zählen — und welche nicht", d: 2, text: "Zu erfassen sind versäumte Ausbildungszeiten **im Betrieb und in der Berufsschule**, entschuldigt wie unentschuldigt. **Urlaub gehört nicht dazu.**\n\nBesonders oft falsch gezählt wird der Berufsschul- und Lehrgangsbesuch: Beides ist nach § 15 BBiG **selbst Ausbildungszeit**. Wer einen überbetrieblichen Lehrgang besucht, fehlt nicht in der Ausbildung, nur weil er an diesem Tag nicht im Betrieb steht. Versäumte Lehrgangstage gehören dagegen gesondert dokumentiert.\n\nFür eine belastbare Übersicht:\n\n- **Tatsächlich ausgefallene Ausbildungstage** erfassen — nicht ungeprüft die Kalendertage einer Krankschreibung übernehmen.\n- **Wochenenden und Feiertage** nicht mitzählen, nur weil sie im bescheinigten Zeitraum liegen.\n- Jeden Ausfall dem **vorgesehenen Lernort** zuordnen (Betrieb, Schule, Lehrgang).\n- **Teilweise versäumte Tage** zunächst in Stunden festhalten; die Umrechnung mit der zuständigen Stelle abstimmen.\n- **Doppelzählungen bereinigen:** Derselbe ausgefallene Schultag ist nicht zusätzlich ein ganzer betrieblicher Fehltag.\n- **Elternzeit** gesondert ausweisen — § 46 Abs. 2 BBiG verbietet ausdrücklich, dass daraus bei der Zulassung ein Nachteil erwächst.\n\n**Zählbeispiel:** Krankschreibung von Montag bis Sonntag. Vorgesehen waren vier betriebliche Tage und ein Berufsschultag; am Wochenende hätte keine Ausbildung stattgefunden. Zu dokumentieren sind **fünf** ausgefallene Ausbildungstage — vier im Betrieb, einer in der Schule. Nicht sieben." },
      { t: "Krankheit wird nicht hinterfragt", d: 2, text: "Bei der fachlichen Einschätzung werden Erkrankungen **weder angezweifelt noch medizinisch bewertet**. Die Frage ist allein, welche Ausbildungsinhalte tatsächlich vermittelt und erworben wurden.\n\nDas ist keine Schuldzuweisung, sondern die Trennung zweier Fragen: **War die Abwesenheit entschuldigt?** Und: **Konnten die erforderlichen Inhalte trotzdem erlernt werden?** Die erste Frage beantwortet das Attest, die zweite nicht.\n\nFür die Einschätzung anhand von Fehlzeiten und Ausbildungsstand sind **Diagnosen und Krankheitsgeschichten regelmäßig nicht erforderlich**. Eine betriebliche Stellungnahme beschreibt fachliche Fähigkeiten und Lücken — keine medizinischen Vermutungen. Werden für andere Anliegen Nachweise gebraucht (etwa für einen [[foerderung|Nachteilsausgleich]] oder zur Begründung eines Verlängerungsantrags), sind diese **zweckbezogen** mit der zuständigen Stelle abzustimmen. Eine allgemeine Aufforderung, Krankenunterlagen einzureichen, folgt daraus nicht." },
      { t: "Was bei der Einzelfallprüfung bewertet wird", d: 3, text: "Die Bewertung verbindet **Umfang und Lage der Ausfälle** mit dem **belegbaren Ausbildungsstand**. Eine positive Einschätzung erklärt deshalb nachvollziehbar, was trotz der Abwesenheit gelernt und wie Versäumtes nachgeholt wurde.\n\nFünf Leitfragen für die Aufbereitung:\n\n1. Welche Ausbildungsabschnitte und Tätigkeiten waren von den Ausfällen betroffen?\n2. Welche Inhalte wurden inzwischen nachgeholt — wann, wie, unter wessen Anleitung?\n3. Welche Tätigkeiten gelingen bereits **selbstständig und sicher**?\n4. Wo fehlen noch Anleitung, Übung oder praktische Erfahrung?\n5. Welche Lücken lassen sich in der verbleibenden Zeit realistisch schließen?\n\nIm Mittelpunkt steht die praktische Seite — gemeint ist, dass die für den Beruf erforderlichen Tätigkeiten ausreichend erlernt und eingeübt wurden. Ein eigenständiger Zulassungstatbestand ist das nicht: Die berufliche Handlungsfähigkeit nach § 38 BBiG umfasst Fertigkeiten, Kenntnisse **und** den wesentlichen Berufsschulstoff. Eine gute Praxiseinschätzung ersetzt deshalb nicht die vollständige Prüfung der Zulassungsvoraussetzungen.\n\n**Im Gartenbau kommt die Jahreszeit dazu:** Pflanz-, Schnitt- oder Pflegearbeiten lassen sich nicht zu jedem Termin nachholen. Ein Nachholplan muss das berücksichtigen — sonst steht dort etwas, das im Februar niemand einlösen kann." },
      { t: "Beispiele aus dem Garten- und Landschaftsbau", d: 3, text: "Maßgeblich sind der Ausbildungsrahmenplan der **GärtnAusbV** (für den GaLaBau die Anlage 3a) und der betriebliche Ausbildungsplan. Diese Tätigkeitsbereiche lohnen den gezielten Blick — die Fragen richten sich an den Ausbildungsbetrieb:\n\n- **Baustellenvorbereitung und Vermessung:** Kann die Person Pläne nutzen, Maße übertragen, Arbeitsabläufe vorbereiten?\n- **Erdarbeiten und Entwässerung:** Boden bearbeiten, Höhen und Gefälle berücksichtigen, bei Entwässerungsarbeiten fachgerecht mitwirken?\n- **Wege, Plätze und bauliche Anlagen:** Welche Arbeiten an Unterbau, Belägen, Einfassungen wurden praktisch ausgeführt?\n- **Pflanzarbeiten und Vegetationstechnik:** Pflanzen standortgerecht verwenden, Pflanz- und Rasenflächen fachgerecht anlegen?\n- **Pflege und Maschinen:** Welche Pflegearbeiten und Geräteeinsätze beherrscht sie unter Beachtung des [[arbeitszeit-jugendliche|Arbeitsschutzes]]?\n\nDas ist eine Arbeitshilfe, keine vollständige Prüfliste. Für die übrigen Fachrichtungen gelten die jeweiligen Rahmenpläne." },
      { t: "Welche Unterlagen die Entscheidung tragen", d: 3, text: "Was im Einzelfall einzureichen ist, legt die zuständige Stelle fest. Bewährt hat sich diese Zusammenstellung:\n\n- **Detaillierte Fehlzeitenübersicht** — Anzahl, Zeiträume, betroffene Ausbildungsjahre und Lernorte\n- **Schriftliche betriebliche Stellungnahme** — praktische Fähigkeiten, vermittelte und nachgeholte Inhalte, verbleibende Lücken\n- **Ergebnis der [[zwischenpruefung|Zwischenprüfung]]** — Hinweis auf den damaligen Ausbildungsstand\n- **Aktuelles Berufsschulzeugnis**, bei Bedarf mit Stellungnahme der Schule\n- **[[berichtsheft|Ausbildungsnachweis]]** — Tätigkeiten und zeitlicher Verlauf\n- **Lehrgangsnachweise** — absolvierte, versäumte und noch nachzuholende überbetriebliche Abschnitte\n- **Ausbildungs- und Nachholplan** — wie fehlende Inhalte gezielt vermittelt werden\n\nDie Zwischenprüfung dient der Ermittlung des Ausbildungsstands und ist deshalb aufschlussreich; ein schwaches Ergebnis muss aber zusammen mit der Entwicklung **seit** der Prüfung gelesen werden. Dass sie bei der Zulassung herangezogen wird, bedeutet **keine Anrechnung auf die Abschlussnote**.\n\n**Für die Fehlzeitenübersicht** genügt eine schlichte Tabelle: Zeitraum · Ausbildungsjahr · vorgesehener Lernort · ausgefallene Tage oder Stunden · entschuldigt ja/nein · betroffene Inhalte und Nachholung. Dazu Ausbildungsbeginn, vertragliches Ende, gegebenenfalls Verkürzung oder Teilzeit. **Diagnosen gehören nicht hinein.**" },
      { t: "Wie eine brauchbare Stellungnahme aussieht", d: 3, text: "Eine hilfreiche Stellungnahme enthält **konkrete Beobachtungen**: wer ausgebildet und beurteilt hat, welche Aufgaben die Person selbstständig erledigt, welche Inhalte noch fehlen, was nachgeholt wurde, wo Übungsbedarf bleibt — und eine begründete Einschätzung zur Prüfungsteilnahme.\n\n**Formulierungsbeispiel:** „Die versäumten Arbeiten zur Herstellung von Wegeflächen wurden zwischen Mai und Juli auf zwei Baustellen nachgeholt. Frau X kann inzwischen Höhen übertragen, Bettungsmaterial abziehen und Betonpflaster im vereinbarten Verband verlegen. Bei der Planung von Entwässerungsanschlüssen benötigt sie noch Anleitung; hierfür sind weitere angeleitete Arbeiten vorgesehen.“\n\nAuch eine **kritische** Einschätzung muss konkret sein. „Zu viele Fehltage“ beschreibt keine fehlende Fähigkeit und trägt deshalb keine Entscheidung. Die E-Mail-Vorlage **„Stellungnahme zum Ausbildungsstand anfordern“** fragt genau diese Punkte ab." },
      { t: "Wer entscheidet — Betrieb, Beratung oder Prüfungsausschuss?", d: 2, text: "**Über die Zulassung entscheidet die zuständige Stelle. Hält sie die Voraussetzungen für nicht gegeben, entscheidet der Prüfungsausschuss** (§ 46 Abs. 1 BBiG).\n\nDaraus folgt zweierlei:\n\n- Eine **negative Stellungnahme des Betriebs ist keine Ablehnung** der Zulassung. Sie ist Anlass, die benannten Lücken mit den übrigen Unterlagen abzugleichen.\n- Eine **positive Stellungnahme garantiert keine Zulassung** — die übrigen Voraussetzungen müssen ebenfalls vorliegen.\n\nDie [[ausbildungsberatung|Ausbildungsberatung]] begleitet den Fall fachlich, ist aber nicht der gesetzliche Entscheidungsträger. Für Auszubildende heißt das praktisch: Antrag und Unterlagen **rechtzeitig** einreichen, offene Punkte schriftlich klären lassen und bei einer Ablehnung Begründung und Rechtsbehelfsbelehrung des Bescheids beachten." },
      { t: "Wann eine Verlängerung in Betracht kommt", d: 2, text: "Eine Verlängerung ist sinnvoll, wenn **wesentliche Inhalte fehlen** und bis zum vorgesehenen Abschluss nicht ausreichend nachgeholt werden können. **Aus dem Überschreiten der 10 % allein folgt noch keine Verlängerung.**\n\nRechtsgrundlage ist **§ 8 Abs. 2 BBiG**: In Ausnahmefällen kann die zuständige Stelle die Ausbildungsdauer **auf Antrag der Auszubildenden** verlängern, wenn das zum Erreichen des Ausbildungsziels erforderlich ist. Vor der Entscheidung wird der Betrieb **angehört**.\n\nZwei Klarstellungen, die in der Beratung immer wieder gebraucht werden:\n\n- Die **Anhörung ist kein Zustimmungsvorbehalt** — ob die Voraussetzungen vorliegen, entscheidet die zuständige Stelle.\n- Der **Betrieb kann eine Verlängerung nicht gegen den Willen der auszubildenden Person durchsetzen**: Das Gesetz setzt deren Antrag voraus.\n\nDie BIBB-Empfehlung HA 129 nennt längere unverschuldete Ausfälle — etwa infolge Krankheit — ausdrücklich als Verlängerungsgrund; der Antrag soll **rechtzeitig vor Vertragsende** gestellt werden und die Dauer die Prüfungstermine berücksichtigen. Wer keine Verlängerung möchte, sollte die Möglichkeiten trotzdem früh besprechen: Der Wunsch nach dem ursprünglichen Termin ersetzt keine fehlenden Zulassungsvoraussetzungen." },
      { t: "Nichtzulassung ist nicht dasselbe wie Nichtbestehen", d: 3, text: "Diese Unterscheidung entscheidet, welcher Weg offensteht:\n\n- **Keine Zulassung zum vorgesehenen Termin wegen erheblicher Lücken:** Es liegt **keine nicht bestandene Prüfung** vor. Zu prüfen ist eine Verlängerung nach § 8 Abs. 2 BBiG.\n- **Teilgenommen und [[nichtbestehen|nicht bestanden]]:** Das Ausbildungsverhältnis verlängert sich **auf Verlangen** der auszubildenden Person bis zur nächstmöglichen Wiederholungsprüfung, höchstens um ein Jahr (§ 21 Abs. 3 BBiG).\n- **Vertrag läuft aus, ohne dass eine Verlängerung greift:** Das Ausbildungsverhältnis endet mit Ablauf der Ausbildungsdauer (§ 21 Abs. 1 BBiG). Ein späterer Prüfungstermin setzt den Vertrag **nicht** von selbst fort.\n\nDer besondere Verlängerungsanspruch aus § 21 Abs. 3 BBiG darf also **nicht** auf eine vorherige Nichtzulassung übertragen werden. Deshalb gehören Antrag, Vertragsende und nächster erreichbarer Prüfungstermin früh zusammen auf den Tisch." },
      { t: "Lücken schließen: der Nachholplan", d: 3, text: "Ausbildungsbetriebe müssen planmäßig so ausbilden, dass das Ausbildungsziel **in der vorgesehenen Zeit** erreicht werden kann, und den Ausbildungsnachweis regelmäßig durchsehen (§ 14 Abs. 1 BBiG). Nach längeren Ausfällen heißt das: nachsteuern, nicht abwarten.\n\nEin knapper Nachholplan reicht — je Zeile: **fehlender Inhalt · geplante praktische Aufgabe · Anleitung und Lernort · Zeitraum · Nachweis des Lernfortschritts** (Beobachtung, Fachgespräch, Eintrag im Ausbildungsnachweis).\n\nWeitere Wege: ein noch ausstehender überbetrieblicher Lehrgang, gezielte Unterweisung oder eine abgestimmte Ausbildungsphase in einem geeigneten anderen Betrieb.\n\nZwei Grenzen:\n\n- **Reines Lernen für Prüfungsfragen ersetzt keine praktische Erfahrung.**\n- Nachholen heißt **nicht**, Krankheitstage durch unzulässige [[ueberstunden|Mehrarbeit]] „abzuarbeiten“.\n\nEin [[aufhebung|Betriebswechsel]] kann die Lage verbessern, wenn wichtige Inhalte woanders besser vermittelt werden — er beseitigt aber weder die bereits entstandenen Ausfälle noch die Frage nach den erworbenen Fähigkeiten. Unterlagen aus den bisherigen Abschnitten deshalb aufbewahren." },
      { t: "Nachteilsausgleich und Fehlzeiten auseinanderhalten", d: 3, text: "Ein [[foerderung|Nachteilsausgleich]] nach § 65 BBiG betrifft die **Bedingungen, unter denen geprüft wird** — Zeitzuschläge, zugelassene Hilfsmittel, Hilfeleistungen Dritter. Das ist eine andere Frage als die nach ausgefallener Ausbildung: **Ein Nachteilsausgleich ersetzt keine fehlenden praktischen Inhalte.**\n\nBeide Anliegen können gleichzeitig bestehen und sollten früh und **getrennt** mit der zuständigen Stelle besprochen werden. Welche Nachweise für den Nachteilsausgleich nötig sind, ist gesondert zu klären — sie folgen nicht aus der Fehlzeitenprüfung." },
      { t: "Die sechs Schritte bei längeren Fehlzeiten", d: 2, text: "1. **Früh Kontakt aufnehmen** — die [[ausbildungsberatung|Ausbildungsberatung]] einschalten, sobald längere Ausfälle oder deutliche Lücken absehbar sind. Nicht bis zur Anmeldung warten.\n2. **Ausfälle nachvollziehbar erfassen** — Betrieb, Schule und Lehrgänge abgleichen, Doppelzählungen bereinigen.\n3. **Lernstand gemeinsam betrachten** — Ausbildungsplan, praktische Fähigkeiten, schulische Leistungen.\n4. **Unterlagen zusammenstellen** — Stellungnahme, Zwischenprüfung, Zeugnis, Ausbildungsnachweis, Lehrgangsbescheinigungen.\n5. **Nachholen konkret planen** — Aufgaben, Termine, verantwortliche Personen.\n6. **Zulassung und ggf. Verlängerung rechtzeitig klären** — nicht das Vertragsende abwarten.\n\nFür ein erstes Gespräch müssen noch nicht alle Nachweise vorliegen: Ausbildungsbeginn, vorgesehenes Ende, ungefähre Fehlzeiten und eine erste Beschreibung des Lernstands reichen meist, um die nächsten Schritte zu vereinbaren." }
    ],
    rollen: {
      azubi: "Viele Fehltage heißen nicht automatisch, dass du nicht geprüft wirst — aber warte nicht ab. Melde dich früh bei der Ausbildungsberatung, sammle deine Fehlzeiten selbst (Tage, Lernort, entschuldigt ja/nein) und sprich mit deinem Betrieb darüber, was du nachholen kannst. Wenn Inhalte fehlen: Die Verlängerung nach § 8 Abs. 2 BBiG beantragst **du**, nicht der Betrieb — und sie sichert dir den Abschluss, statt eine Nichtzulassung zu riskieren.",
      betrieb: "Ihre Stellungnahme wiegt fachlich schwer — aber nur, wenn sie konkret ist: Was kann die Person selbstständig, was wurde nachgeholt, wo fehlt Übung? „Zu viele Fehltage“ trägt keine Entscheidung. Rechnen Sie Berufsschul- und Lehrgangstage nicht als Fehlzeit; sie sind Ausbildungszeit. Und steuern Sie nach längeren Ausfällen aktiv nach — § 14 Abs. 1 BBiG verlangt, dass das Ausbildungsziel in der vorgesehenen Zeit erreichbar bleibt.",
      beratung: "Zuerst die Zählweise prüfen — erfahrungsgemäß sind gemeldete Fehlzeiten zu hoch angesetzt: Kalendertage statt Ausbildungstage, Wochenenden mitgezählt, Schultage doppelt. Dann Umfang und Lage der Ausfälle gegen den belegbaren Ausbildungsstand halten. Die 66/75-Tage-Staffel ist örtliche Praxis, keine Norm: § 46 Abs. 1 BBiG kann den Prüfungsausschuss auch darunter erforderlich machen. Elternzeit gesondert ausweisen (§ 46 Abs. 2 BBiG). Diagnosen nicht anfordern."
    },
    faq: [
      { f: "Wie viele Fehltage sind bei der Ausbildung erlaubt?", a: "Das BBiG nennt **keine** Höchstzahl. In der Praxis gelten Fehlzeiten bis etwa **10 % der maßgeblichen Ausbildungszeit** als geringfügig — bei drei Jahren und pauschal 220 Ausbildungstagen im Jahr sind das rund 66 Tage. Darüber wird im Einzelfall geprüft, ob genug Ausbildung stattgefunden hat. Eine feste Ausschlussgrenze ist das nicht." },
      { f: "Ich war lange krank — werde ich trotzdem zur Prüfung zugelassen?", a: "Möglicherweise ja. Entschieden wird nach Umfang und Lage der Ausfälle **zusammen mit** dem erreichten Ausbildungsstand. Hilfreich sind eine saubere Fehlzeitenübersicht, eine konkrete betriebliche Stellungnahme und ein Nachholplan. Wenn wesentliche Inhalte fehlen, ist eine [[teilzeit-verkuerzung|Verlängerung nach § 8 Abs. 2 BBiG]] oft der bessere Weg als eine riskierte Nichtzulassung." },
      { f: "Zählen Berufsschultage und Lehrgänge als Fehlzeit?", a: "Nein. Berufsschulunterricht und vorgeschriebene überbetriebliche Lehrgänge sind nach § 15 BBiG **selbst Ausbildungszeit** — wer dort ist, fehlt nicht. Nur **versäumte** Schul- oder Lehrgangstage zählen, und die werden gesondert dokumentiert." },
      { f: "Zählt Urlaub zu den Fehlzeiten?", a: "Nein. Urlaub ist gewährte Freistellung und gehört nicht in die Fehlzeitenübersicht." },
      { f: "Muss ich meine Diagnose offenlegen?", a: "Für die Einschätzung anhand von Fehlzeiten und Ausbildungsstand in aller Regel nicht. Erkrankungen werden weder angezweifelt noch medizinisch bewertet — es geht darum, welche Inhalte vermittelt wurden. Für andere Anliegen (Nachteilsausgleich, Begründung eines Verlängerungsantrags) können gezielte Nachweise nötig sein; das wird zweckbezogen mit der zuständigen Stelle abgestimmt." },
      { f: "Kann der Betrieb mir die Prüfung verweigern?", a: "Nein. Über die Zulassung entscheidet die **zuständige Stelle**, bei Zweifeln der **Prüfungsausschuss** (§ 46 Abs. 1 BBiG). Der Betrieb gibt eine fachliche Einschätzung ab — eine negative Stellungnahme ist noch keine Ablehnung, eine positive noch keine Zulassung." },
      { f: "Was ist der Unterschied zwischen Nichtzulassung und Nichtbestehen?", a: "Bei einer **Nichtzulassung** hat die Prüfung nicht stattgefunden — es gibt keinen Verlängerungsanspruch aus § 21 Abs. 3 BBiG, sondern nur die Verlängerung auf Antrag nach § 8 Abs. 2 BBiG. Nach einer **[[nichtbestehen|nicht bestandenen Prüfung]]** verlängert sich das Ausbildungsverhältnis dagegen auf Verlangen bis zur nächstmöglichen Wiederholungsprüfung, höchstens um ein Jahr." },
      { f: "Wer beantragt die Verlängerung — Betrieb oder Azubi?", a: "Die **auszubildende Person**. § 8 Abs. 2 BBiG setzt ihren Antrag voraus; der Betrieb wird vor der Entscheidung lediglich **angehört**. Der Betrieb kann eine Verlängerung also nicht gegen ihren Willen durchsetzen — und seine Anhörung ist kein Zustimmungsvorbehalt." },
      { f: "Werden Fehlzeiten aus dem ersten Lehrjahr noch berücksichtigt?", a: "Ja. Der 10-%-Richtwert bezieht sich auf die **gesamte maßgebliche Ausbildungszeit**, nicht nur auf das letzte Jahr. Welcher Zeitraum und welche Berechnung im konkreten Fall gelten — etwa bei Verkürzung, Teilzeit oder angerechneten Zeiten — klärt die zuständige Stelle." }
    ],
    verwandt: ["abschlusspruefung", "krankmeldung", "nichtbestehen"]
  },
  ...
  /* =================== Konflikte, Kündigung & Ende ================== */
  {
    ...
    fakten: [
      ...
      "**Stufe 3:** die [[ausbildungsberatung|Ausbildungsberatung]] der zuständigen Stelle — neutral, kostenlos, für beide Seiten.",
    ...
    abschnitte: [
      ...
      { t: "Schlichtung vor Klage", d: 3, text: "Für Streitigkeiten aus einem **bestehenden** Berufsausbildungsverhältnis (z. B. Wirksamkeit einer [[kuendigung|Kündigung]], Vergütungsforderungen) gilt: Ist bei der zuständigen Stelle ein Schlichtungsausschuss eingerichtet, ist seine Anrufung **zwingende Voraussetzung** einer Klage. Der Ausschuss ist paritätisch besetzt (Arbeitgeber-/Arbeitnehmerseite), das Verfahren schnell und kostenfrei; ein angenommener Spruch wirkt wie ein Vergleich. Ob und wo ein Ausschuss besteht, teilt die zuständige Stelle mit — Fristen (insb. bei Kündigung: **3 Wochen**) unbedingt beachten." },
      { t: "Eskalation vermeiden — Warnsignale ernst nehmen", d: 3, text: "Vertragslösungen kündigen sich an: häufige Fehlzeiten, [[berichtsheft|Berichtsheftlücken]], Rückzug im Betrieb, Konflikte über Aufgaben. Wer früh reagiert (Gespräch, Beratung, Förderinstrumente wie die [[foerderung|Assistierte Ausbildung]]), verhindert die meisten Abbrüche. Für Betriebe gilt: Abmahnungen ersetzen keine Ausbildungsgespräche; für Azubis: Nicht einfach wegbleiben — das schafft neue Pflichtverletzungen." }
    ],
    rollen: {
...

  {
    ...
    faq: [
      ...
      { f: "Wie kann ich selbst kündigen, wenn ich den Beruf wechseln will?", a: "Mit einer Frist von vier Wochen, schriftlich, wenn du die Berufsausbildung aufgibst oder dich für einen anderen Beruf ausbilden lassen willst (§ 22 Abs. 2 Nr. 2 BBiG). Bist du minderjährig, müssen deine Eltern zustimmen. Sprich vorher mit der Ausbildungsberatung — oft ist ein [[aufhebung|Betriebswechsel im selben Beruf]] die bessere Lösung." },
...

  {
    ...
    abschnitte: [
      { t: "Sauberer Wechsel in fünf Schritten", d: 2, text: "1. **Anschluss sichern:** neuen Ausbildungsbetrieb finden ([[ausbildungsberatung|Ausbildungsberatung]] und Agentur für Arbeit vermitteln).\n2. **Aufhebungsvertrag** mit Datum, letztem Tag, [[urlaub|Resturlaub]], [[zeugnis|Zeugnisanspruch]] und Herausgabe der Unterlagen schließen.\n3. **Neuen Vertrag** über die Restzeit schließen und [[eintragung|eintragen]] lassen; Verkürzung/Verlängerung realistisch festlegen.\n4. **Berufsschule** informieren (Klassenwechsel meist unnötig).\n5. [[berichtsheft|Berichtsheft]] nahtlos weiterführen — es dokumentiert beide Stationen.\n\nSo geht keine Zeit verloren und die Zulassung zur Prüfung bleibt gesichert." }
    ],
    rollen: {
...

  {
    ...
    fakten: [
      ...
      "Zum Ende: [[zeugnis|Zeugnis]], Arbeitspapiere, [[urlaub|Resturlaub]] abwickeln; ohne Anschluss **frühzeitig arbeitsuchend melden** (3 Monate vor Ende)."
    ],
    abschnitte: [
  ...
  /* =================== Ausbildungsberatung & Aufsicht =============== */
  {
    ...
    abschnitte: [
      { t: "Wann Sie sich melden sollten", d: 2, text: "- **vor** dem ersten Ausbildungsvertrag ([[ausbilder|Anerkennung als Ausbildungsbetrieb, Ausbildereignung]])\n- bei **Vertragsabschluss und Änderungen** ([[eintragung|Eintragung]], [[teilzeit-verkuerzung|Verkürzung, Teilzeit]], Ausbilderwechsel)\n- bei **Fragen und [[konflikte|Konflikten]]** in laufenden Ausbildungen\n- zur **Prüfungsorganisation** ([[abschlusspruefung|Anmeldung, Termine]], Nachteilsausgleich)\n- bei **vorzeitiger Beendigung** (Meldepflicht, [[aufhebung|Vermittlung]])" }
    ],
    rollen: {
...

  {
    ...
    fakten: [
      ...
      "**AsA flex:** kostenlose Unterstützung der Agentur für Arbeit (Stützunterricht, sozialpädagogische Begleitung) — für Azubis **und** entlastend für Betriebe; oft die Rettung vor [[nichtbestehen|Prüfungsmisserfolg]] oder [[kuendigung|Vertragslösung]].",
      "**Finanzielle Hilfen:** Berufsausbildungsbeihilfe (BAB), ggf. Wohn- und Fahrtkostenzuschüsse.",
      "**[[einstiegsqualifizierung|Einstiegsqualifizierung (§ 54a SGB III)]]:** vier bis zwölf Monate im Betrieb vor der Ausbildung — auch in Betrieben, die nicht als Ausbildungsstätte anerkannt sind.",
    ...
    faq: [
      ...
      { f: "Was ist ein Fachpraktiker im Gartenbau?", a: "Eine Ausbildung nach § 66 BBiG für Menschen mit Behinderung: praxisorientiert, mit reduzierter Theorie und eigener Prüfung. Sie kann als Sprungbrett in die reguläre Gärtner-Ausbildung dienen — Ausbildungszeiten können angerechnet werden. Ausführlich im Themenbereich [[fw-grundlagen|Fachwerker-Ausbildung]]." }
    ],
     ...
     personenbezogenen Kontaktteil). ================================= */
  {
    ...
    fakten: [
      ...
      "Voraussetzung ist die [[fw-weg|Eignungsfeststellung des zuständigen Rehabilitationsträgers]] (meist Reha-Team der Agentur für Arbeit) — schlechte Noten, fehlender Schulabschluss oder SBBZ-Besuch reichen **nicht**.",
...

  {
    ...
    fakten: [
      "**Vier Stopppunkte** vor dem Start: kein schriftliches Eignungsergebnis · kein gesicherter Ausbildungsplatz · [[fw-betrieb|ReZA/Unterstützung]] ungeklärt · [[fw-geld|Finanzierung]] nur „in Aussicht“ — bei jedem Stopp gilt: erst klären, dann weiter.",
...

  {
    ...
    fakten: [
      ...
      "[[teilzeit-verkuerzung|Teilzeit]] (§ 7a BBiG) und das **Budget für Ausbildung** (§ 61a SGB IX) lassen sich mit den Modellen kombinieren."
    ],
    abschnitte: [
      ...
      { t: "Budget für Ausbildung (§ 61a SGB IX)", d: 3, text: "Für den gesetzlich bestimmten Personenkreis — insbesondere Menschen mit Anspruch auf Leistungen im Arbeitsbereich einer Werkstatt — kann das Budget für Ausbildung eine **betriebliche** Ausbildung ermöglichen: Es kann die Ausbildungsvergütung einschließlich des Arbeitgeberanteils zur Sozialversicherung sowie erforderliche Anleitung und Begleitung finanzieren. Die Voraussetzungen sind strikt im Einzelfall zu prüfen; zuständig ist der Rehabilitationsträger. Alle Geldflüsse im Überblick: [[fw-geld|Finanzierung & Förderung]]." }
    ],
    rollen: {
