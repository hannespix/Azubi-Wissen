...
window.VORLAGEN = {
  ...
  { id: "externenpruefung",
    ...
    text: "Sehr geehrte/r [ANREDE_NAME],\n\nvielen Dank für Ihre Anfrage zur Abschlussprüfung im Beruf [BERUF] (Fachrichtung: [FACHRICHTUNG]) ohne vorherige Ausbildung — der sogenannten Externenprüfung. Den **Anmeldebogen** finden Sie im Anhang.\n\n**Anmeldefrist:** [ANTRAGSFRIST] für die Prüfung [PRUEFUNGSTERMIN].\n\n**Diese Unterlagen benötigen wir:**\n1. schriftlicher Zulassungsantrag (formlos, von Ihnen unterschrieben)\n2. Anmeldebogen zur Abschlussprüfung (anbei)\n3. Kopien betrieblicher Bescheinigungen und/oder Zeugnisse über **sämtliche geleisteten Arbeitszeiten** im Gartenbau bzw. über Art und Umfang der gärtnerischen Tätigkeiten\n4. tabellarischer Lebenslauf\n5. letztes Zeugnis der allgemeinbildenden Schule\n\n**Zulassung (§ 45 Abs. 2 BBiG):** Zugelassen wird, wer mindestens das **Anderthalbfache der Ausbildungsdauer** im Beruf tätig war — bei drei Jahren Regelausbildungszeit also **4,5 Jahre, auch mit Abitur**. Wird diese Zeit in der Summe nicht erreicht, kann sie ganz oder teilweise entfallen, wenn Sie durch Zeugnisse oder auf andere Weise glaubhaft machen, dass Sie die berufliche Handlungsfähigkeit erworben haben. Ausländische Abschlüsse und Tätigkeiten im Ausland werden berücksichtigt.\n\n**So läuft die Prüfung ab:**\n- **Praktischer Prüfungstag:** fünf praktische Aufgaben (zusammen 3,5–4,5 Stunden), Pflanzenbestimmung (20 Pflanzen in 20 Minuten) und mündliche Prüfung (60 Minuten).\n- **Vorher an der Berufsschule:** drei schriftliche Prüfungen (Betriebliche Zusammenhänge, Wirtschafts- und Sozialkunde, Pflanzenkenntnisse). Diese Noten fließen zusammen mit den Bereichen des praktischen Tages in das Berufsabschlusszeugnis ein.\n- Die **Berufsschule müssen Sie vorher nicht besuchen** — das ist ohne Ausbildungsvertrag auch nicht möglich.\n- Als externe Teilnehmerin bzw. externer Teilnehmer legen Sie **kein Berichtsheft** vor, und ein Nachweis über überbetriebliche Lehrgänge (z. B. DEULA) ist **nicht** erforderlich.\n- Das **Prüfungsniveau entspricht dem der regulären Gesellenprüfung**; maßgeblich sind die Inhalte der Ausbildungsordnung für Ihre Fachrichtung (anbei).\n\n**Zur Vorbereitung:**\n- Ausbildungsordnung mit Ausbildungsrahmenplan (GärtnAusbV) und der betriebliche Ausbildungsplan Ihrer Fachrichtung — beide kostenlos als PDF\n- die **Pflanzenlisten** Ihrer Fachrichtung, Grundlage der Pflanzenbestimmung; üben lässt sich damit kostenlos auf pflanze-bw.de\n- Berufsschul-Standardwerke, z. B. „Fachkunde für Gärtner“ (Handwerk und Technik) oder die Reihe „Der Gärtner“ (Ulmer) mit dem Band Ihrer Fachrichtung; zur Prüfungsvorbereitung außerdem Frage-Antwort-Bände wie „Prüfungsbuch Gartenbau“. Bitte auf die aktuelle Auflage achten — die Buchhandlung oder die berufsbildende Schule berät dazu.\n\nZu Lernmaterial und Prüfungsaufgaben können wir darüber hinaus leider wenig Hilfestellung geben. Für Fragen zum Verfahren stehen wir Ihnen gerne zur Verfügung.\n\nMit freundlichen Grüßen\n[EIGENER_NAME]\n[ORGANISATIONSEINHEIT]",
    hinweise: "Anmeldeschluss: 1. November für die Winterprüfung, 1. April für die Sommerprüfung — das Fristfeld ist damit vorbelegt; Prüfungstermin je Durchgang eintragen. Prüfungsablauf und Buchhinweise sind am Beispiel Gärtner/in formuliert — bei anderen Berufen Aufgabenzahl, Zeiten und Literatur anpassen. Bei offensichtlich fehlenden Zeiten früh auf Nachqualifizierungswege (Umschulung, Teilzeitausbildung) hinweisen. Keine einzelnen Händler oder Bezugsquellen empfehlen.",
